import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{r as s}from"./index-CTZeEbLr.js";import{F as i}from"./Flex-7H_pA1dJ.js";import{T as d}from"./TextField-Bvd1mJq5.js";import{u as f}from"./index-CqkoFCDi.js";import{T as v}from"./Tooltip-BB_8xbyk.js";const g="_textContainer_11qne_1",O="_input_11qne_12",l={textContainer:g,input:O},w={title:"Hooks/useIsOverflowing"},t={render:()=>{const x=({text:n})=>{const r=s.useRef(null),o=f({ref:r});return e.jsxs(i,{direction:"column",gap:"medium",align:"start",children:[e.jsxs("div",{children:["Is overflowing: ",o.toString()]}),e.jsx(v,{content:o?n:void 0,children:e.jsx("div",{ref:r,className:l.textContainer,children:n})})]})},[p,u]=s.useState("");return e.jsxs(i,{direction:"column",gap:"small",align:"start",children:[e.jsx(d,{onChange:u,placeholder:"Type text here",className:l.input}),e.jsx(x,{text:p})]})},name:"Overview"};var a,c,m;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => {
