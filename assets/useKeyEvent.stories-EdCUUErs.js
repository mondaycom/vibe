import{j as i}from"./jsx-runtime-lwGtIXvq.js";import{r as m}from"./index-CTZeEbLr.js";import{u as c}from"./useKeyEvent-BeN1aNjK.js";const d={title:"Hooks/useKeyEvent"},e={render:()=>{const[a,n]=m.useState("-");return c({keys:["1","2","3","4","5","6","7","8","9","0"],callback:o=>n(o.key)}),i.jsxs("div",{children:["Last pressed digit: ",a]})},name:"Overview"};var r,s,t;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => {
