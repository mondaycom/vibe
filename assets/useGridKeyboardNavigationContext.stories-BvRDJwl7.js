import{j as t}from"./jsx-runtime-lwGtIXvq.js";import{r as n}from"./index-CTZeEbLr.js";import{c as I}from"./createStoryMetaSettingsDecorator-C07DgdqT.js";import{D as d,L as b}from"./useGridKeyboardNavigationContext.stories.helpers-DM3I_8yt.js";import{i as P,r as D,a as T,c as j,t as a,e as x}from"./interactions-utils-CrzSbhpz.js";import{F as c}from"./Flex-7H_pA1dJ.js";import{a as f,G as p}from"./useGridKeyboardNavigation-CdqIwhDN.js";const K=async r=>{const e=await T(r,"TL 3");j(e),await a("{arrowRight}",2),await i("TL 5"),await a("{arrowRight}",2),await i("TR 1"),await a("{arrowDown}",2),await i("TR 5"),await a("{arrowLeft}",3),await i("TL 1"),await a("{arrowDown}",4),await i("TB 5"),await a("{arrowDown}",1),await i("BL 1"),await a("{arrowUp}",1),await i("TB 5"),await a("{arrowUp}",3),await i("TL 4")},O=P({tests:[K],afterEach:async()=>{await D()}});async function i(r){const e=document.getElementsByClassName("active-item");x(e).toHaveLength(1),x(e[0]).toHaveTextContent(r)}const R=I({component:f}),k={title:"Hooks/useGridKeyboardNavigationContext",component:f,argTypes:R.argTypes,decorators:R.decorators},l={render:()=>{const r=n.useRef(null),e=n.useRef(null),o=n.useRef(null),s=f([{leftElement:e,rightElement:o}],r);return t.jsx(p.Provider,{value:s,children:t.jsxs(c,{ref:r,children:[t.jsx(d,{ref:e,itemsCount:15,numberOfItemsInLine:4,itemPrefix:"L"}),t.jsx(d,{ref:o,itemsCount:7,numberOfItemsInLine:2,itemPrefix:"R"})]})})},name:"Overview"},m={render:()=>{const r=n.useRef(null),e=n.useRef(null),o=n.useRef(null),s=n.useRef(null),G=f([{topElement:e,bottomElement:o},{topElement:o,bottomElement:s}],r);return t.jsx(p.Provider,{value:G,children:t.jsxs(c,{ref:r,direction:"column",justify:"center",className:"use-grid-keyboard-dummy-grid-wrapper",children:[t.jsx(d,{ref:e,itemsCount:3,numberOfItemsInLine:3,itemPrefix:"T"}),t.jsx(d,{ref:o,itemsCount:3,numberOfItemsInLine:3,itemPrefix:"M",disabled:!0}),t.jsx(d,{ref:s,itemsCount:3,numberOfItemsInLine:3,itemPrefix:"B"})]})})},name:"Disabled Elements"},u={render:()=>{const r=n.useRef(null),e=n.useRef(null),o=n.useRef(null),s=f([{topElement:e,bottomElement:o}],r);return t.jsx(p.Provider,{value:s,children:t.jsxs(c,{id:"twoGridLayoutsWrapper",ref:r,direction:"column",tabIndex:-1,children:[t.jsx(b,{id:"gridLayoutTop",itemPrefix:"T",ref:e}),t.jsx(b,{id:"gridLayoutBottom",itemPrefix:"B",ref:o})]})})},name:"Multiple Depths",play:O};var y,E,v;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => {
