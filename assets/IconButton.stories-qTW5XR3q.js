import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{p as x}from"./person1-D9Wcho68.js";import{c as X}from"./createStoryMetaSettingsDecorator-6la21Z9h.js";import{i as N,d as b,r as v}from"./index-BsvsTenc.js";import{r as V}from"./createComponentTemplate-B08h-OOW.js";import{l as u,V as a,t as i}from"./Workspace-D_pV6T_J.js";import{r as g}from"./Wand-CS0YeGd1.js";import{t as h}from"./Drag-8qsbRXq_.js";import{a as I}from"./CloseSmall-DUYWL2FE.js";import{a as q}from"./link-CVYAeutz.js";import{I as n}from"./IconButton-BSIUJ3oq.js";import{B as P}from"./Box-BwRYjhPo.js";import{F as t}from"./Flex-Bmm6kMUW.js";import{I as p}from"./Icon-BKjd_X8Z.js";import{T as o}from"./Text-BnWTa7DZ.js";import{D as G}from"./Divider-5b08Ypxw.js";import{A as J}from"./Avatar-C-7illfz.js";import{B as Q}from"./Button-DTdAuCzP.js";const B=X({component:n,iconPropNamesArray:["icon"],actionPropsArray:["onClick"]}),U=V(n),Y={title:"Components/IconButton",component:n,argTypes:B.argTypes,decorators:B.decorators},r={render:U.bind({}),args:{id:"overview-icon-button",ariaLabel:"Add",icon:N},parameters:{docs:{liveEdit:{isEnabled:!1}}}},s={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"kinds-primary",icon:u,kind:"primary",ariaLabel:"My primary IconButton"}),e.jsx(n,{id:"kinds-secondary",icon:u,kind:"secondary",ariaLabel:"My secondary IconButton"}),e.jsx(n,{id:"kinds-tertiary",icon:u,kind:"tertiary",ariaLabel:"My tertiary IconButton"})]}),parameters:{docs:{liveEdit:{scope:{Bolt:u}}}}},d={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"sizes-xxs",icon:a,kind:"secondary",size:"xxs",ariaLabel:"My xxs IconButton"},"xxs"),e.jsx(n,{id:"sizes-xs",icon:a,kind:"secondary",size:"xs",ariaLabel:"My xs IconButton"},"xs"),e.jsx(n,{id:"sizes-small",icon:a,kind:"secondary",size:"small",ariaLabel:"My small IconButton"},"small"),e.jsx(n,{id:"sizes-medium",icon:a,kind:"secondary",size:"medium",ariaLabel:"My medium IconButton"},"medium"),e.jsx(n,{id:"sizes-large",icon:a,kind:"secondary",size:"large",ariaLabel:"My large IconButton"},"large")]}),parameters:{docs:{liveEdit:{scope:{Robot:a}}}}},l={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"active-primary",icon:i,kind:"primary",ariaLabel:"My small active IconButton",active:!0}),e.jsx(n,{id:"active-secondary",icon:i,kind:"secondary",ariaLabel:"My active medium IconButton",active:!0}),e.jsx(n,{id:"active-tertiary",icon:i,kind:"tertiary",ariaLabel:"My active large IconButton",active:!0})]}),parameters:{docs:{liveEdit:{scope:{Doc:i}}}}},c={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"disabled-primary",icon:i,kind:"primary",ariaLabel:"My small disabled IconButton",disabled:!0,disabledReason:"This function is not available"}),e.jsx(n,{id:"disabled-secondary",icon:i,kind:"secondary",ariaLabel:"My disabled medium IconButton",disabled:!0,disabledReason:"This function is not available"}),e.jsx(n,{id:"disabled-tertiary",icon:i,kind:"tertiary",ariaLabel:"My disabled large IconButton",disabled:!0,disabledReason:"This function is not available"})]}),parameters:{docs:{liveEdit:{scope:{Doc:i}}}}},m={render:()=>e.jsx(P,{border:!0,rounded:"medium",style:{width:"50%"},children:e.jsxs(t,{direction:"column",align:"start",children:[e.jsxs(t,{gap:"small",style:{padding:"var(--sb-spacing-small)"},children:[e.jsx(p,{icon:h}),e.jsx(o,{type:"text1",children:"Widget name"}),e.jsx(n,{id:"toolbar-filter-button",icon:g,ariaLabel:"Filter the widget by everything",size:"small"})]}),e.jsx(G,{withoutMargin:!0}),e.jsx("div",{style:{height:"200px",width:"100%",backgroundColor:"var(--sb-primary-background-hover-color)"}})]})}),parameters:{docs:{liveEdit:{scope:{Drag:h,Filter:g}}}},name:"Icon button as toolbar button"},y={render:()=>e.jsxs(t,{gap:"medium",style:{width:"100%"},children:[e.jsx(P,{border:!0,rounded:"small",paddingX:"large",style:{width:"100%"},children:e.jsxs(t,{justify:"start",gap:"large",style:{height:"94px"},children:[e.jsxs(t,{direction:"column",justify:"center",style:{color:"var(--sb-icon-color)"},children:[e.jsx(p,{icon:v,iconSize:40}),e.jsx(o,{type:"text1",id:"monday-recycle-bin-title",children:"Item"})]}),e.jsx(G,{direction:"vertical"}),e.jsx(J,{size:"large",src:x,type:"img"}),e.jsxs(t,{direction:"column",align:"start",ariaLabelledby:"monday-recycle-bin-title",style:{flexGrow:1},children:[e.jsxs(t,{gap:"xs",children:[e.jsx(q,{withoutSpacing:!0,href:"",children:"Hadas Farhi"}),e.jsx("span",{children:"deleted the item"}),e.jsx(o,{type:"text1",element:"span",weight:"medium",children:"Hello World"}),e.jsx("span",{children:"from the board"})]}),e.jsx(o,{type:"text1",element:"span",weight:"medium",children:"Tasks"}),e.jsxs(t,{gap:"xs",children:[e.jsx(p,{icon:b}),e.jsx(o,{weight:"medium",children:"13m"}),e.jsx(o,{children:"(Available for restore in the next 1M)"})]})]}),e.jsx(Q,{id:"restore-button",ariaLabel:"Restore deleted item",children:"Restore"})]})}),e.jsx(n,{id:"close-recycle-button",icon:I,size:"small",ariaLabel:"Remove from Recycle bin"})]}),parameters:{docs:{liveEdit:{scope:{person1:x,Item:v,Time:b,CloseSmall:I}}}},name:"Icon button as close button"};var j,f,k;r.parameters={...r.parameters,docs:{...(j=r.parameters)==null?void 0:j.docs,source:{originalSource:`{
...
}`,...(F=(z=d.parameters)==null?void 0:z.docs)==null?void 0:F.source}}};var S,R,D;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => <div style={{
    display: "flex",
    justifyContent: "space-evenly",
    alignItems: "center",
...
}`,...(D=(R=l.parameters)==null?void 0:R.docs)==null?void 0:D.source}}};var E,A,C;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => <div style={{
    display: "flex",
    justifyContent: "space-evenly",
    alignItems: "center",
...
}`,...(C=(A=c.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};var _,O,H;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(H=(O=m.parameters)==null?void 0:O.docs)==null?void 0:H.source}}};var W,$,K;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
