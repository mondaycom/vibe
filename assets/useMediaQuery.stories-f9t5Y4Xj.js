import{j as n}from"./jsx-runtime-lwGtIXvq.js";import{u}from"./index-B61AoO3D.js";const l={title:"Hooks/useMediaQuery"},e={render:()=>{const[i]=u(["screen and (max-width: 1023px) and (min-width: 768px)"]);return n.jsxs("div",{children:['media query - "screen and (max-width: 1023px) and (min-width: 768px)" is matching: ',i?"true":"false"]})},name:"Single Rule"},r={render:()=>{const[i,o]=u(["screen and (max-width: 1280px) and (min-width: 768px)","prefers-color-scheme: dark"]);return n.jsxs("div",{children:[n.jsxs("div",{children:['media query - "screen and (max-width: 1280px) and (min-width: 768px)" is matching: ',i?"true":"false"]}),n.jsxs("div",{children:["media query - prefers-color-scheme: dark is matching: ",o?"true":"false"]})]})},name:"Multiple Rules"};var a,s,d;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => {
