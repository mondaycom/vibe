import{j as e}from"./jsx-runtime-DDzbWKUH.js";import{a as t,B as r}from"./BreadcrumbItem-BqKF1BCI.js";import{A as _}from"./Avatar-DBQ5wLiv.js";import{c as C}from"./createStoryMetaSettingsDecorator-DIIwAjh2.js";import{B as O,a as p}from"./BreadcrumbMenuItem-CdpRHfEy.js";import{u as N,x as l}from"./index-CUPFiJE2.js";import{j as m,d,i as x}from"./Workspace-BIJf5qCK.js";import{F as P}from"./Flex-BwTwg4EO.js";import{T as R}from"./Text-C3O7wRxm.js";const B=""+new URL("person3-D84NPWTh.png",import.meta.url).href,D="_list_1rdx3_1",b={list:D},I=C({component:t}),z={title:"Components/BreadcrumbsBar/BreadcrumbsBar",component:t,argTypes:{...I.argTypes,children:{description:"Breadcrumb item, each containing text and an optional icon, or a BreadcrumbMenu",control:"object",table:{type:{summary:"(BreadcrumbItemProps | BreadcrumbMenuProps)[]",detail:`{
            text: string;
            icon?: React.ReactNode;
            children?: BreadcrumbMenuItemProps[];
          }[]`},defaultValue:{summary:'[ { text: "Workspace", icon: <IconName /> } ]'}}}},decorators:I.decorators,parameters:{docs:{transformSource:a=>a.replace(/icon:\s*function[^{]+\{[^}]+\}/g,"icon: <Icon />"),liveEdit:{scope:{Board:d,Group:m,Item:N}}}}},n={render:a=>e.jsx(t,{...a,children:a.children&&a.children.map(u=>e.jsx(r,{text:u.text,icon:u.icon},u.text))}),args:{children:[{text:"Workspace",icon:x},{text:"Folder",icon:l},{text:"Board",icon:d},{text:"Group",icon:m}]},parameters:{docs:{liveEdit:{isEnabled:!1}}}},s={render:()=>e.jsxs(t,{type:"indication",children:[e.jsx(r,{text:"Workspace",isCurrent:!0}),e.jsx(r,{text:"Folder"}),e.jsx(r,{text:"Board"}),e.jsx(r,{text:"Group"})]}),name:"Text only"},o={render:()=>e.jsxs(t,{type:"navigation",children:[e.jsx(r,{text:"Workspace",icon:x,isCurrent:!0}),e.jsx(r,{text:"Folder",icon:l}),e.jsx(r,{text:"Board",icon:d}),e.jsx(r,{text:"Group",icon:m})]}),parameters:{docs:{liveEdit:{scope:{Workspace:x,Folder:l}}}},name:"With icons"},c={render:()=>e.jsxs(P,{gap:"small",children:[e.jsx(_,{size:"medium",src:B,type:"img"}),e.jsxs("div",{className:b.list,children:[e.jsx(R,{type:"text1",weight:"medium",children:"Rotem Dekel"}),e.jsxs(t,{type:"navigation",children:[e.jsx(r,{text:"User research",icon:d}),e.jsx(r,{text:"Video sessions",icon:m})]})]})]}),parameters:{docs:{liveEdit:{scope:{styles:b,person3:B}}}},name:"Navigatable breadcrumbs"},i={render:()=>e.jsxs(t,{type:"navigation",children:[e.jsx(r,{text:"Board",icon:d}),e.jsx(r,{text:"Group",icon:m}),e.jsxs(O,{children:[e.jsx(p,{title:"Item 1",onClick:()=>alert("Item 1 clicked")}),e.jsx(p,{title:"Item 2",link:"https://www.monday.com"}),e.jsx(p,{title:"Item 3",link:"https://www.monday.com"})]}),e.jsx(r,{text:"My Item",icon:N,isCurrent:!0})]})};var g,h,y;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
