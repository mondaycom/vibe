import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{r as L}from"./index-CTZeEbLr.js";import{V as M}from"./index-DLpaL66y.js";import{c as V,o as q}from"./createStoryMetaSettingsDecorator-DJeVV-64.js";import{I as o}from"./Icon-DN6IoOvm.js";import{l}from"./Workspace-DZbcEHYw.js";import{r as N}from"./createComponentTemplate-B08h-OOW.js";import{S as $}from"./Search-BgEcjBoi.js";import{F as k}from"./Flex-DZptE16X.js";const p=V({component:o,iconPropNamesArray:["icon"]}),Q=N(o),D={title:"Components/Icon",component:o,argTypes:p.argTypes,decorators:p.decorators},r={render:Q.bind({}),name:"Overview",args:{id:"overview-icon",icon:l},parameters:{docs:{liveEdit:{isEnabled:!1}}}},s={render:()=>e.jsx(o,{id:"vibe-icon",type:"svg",icon:l,label:"my bolt svg icon",size:16}),parameters:{docs:{liveEdit:{scope:{Bolt:l}}}}},a={render:()=>e.jsx(o,{id:"font-icon",type:"font",label:"my font awesome start icon",icon:"fa fa-star"})},t={render:()=>e.jsx(o,{id:"custom-svg-icon",type:"src",icon:"https://cdn.monday.com/images/apps/custom-icons/Form.svg",label:"my src awesome icon",size:20,useCurrentColor:!0})},c={render:()=>e.jsx("div",{style:{color:"var(--sb-color-sofia_pink)"},children:e.jsx(o,{id:"colored-icon",type:"svg",icon:l,label:"my bolt svg icon",size:16})}),parameters:{docs:{liveEdit:{scope:{Bolt:l}}}}},i={render:()=>{const[m,_]=L.useState("");return e.jsxs("section",{style:{width:"100%"},children:[e.jsx($,{value:m,onChange:_,placeholder:"Search for icons"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(250px, 1fr))",gap:"var(--sb-spacing-large)",marginTop:"var(--sb-spacing-large)"},children:q.filter(n=>`${n.tags},${n.name}`.toLowerCase().includes(m.toLowerCase())).map(n=>{const O=n.file.split(".")[0],B=M[O];return e.jsx(e.Fragment,{children:e.jsxs(k,{style:{color:"var(--sb-icon-color)"},gap:"small",children:[e.jsx(o,{icon:B,size:26}),e.jsx("span",{children:n.name})]})})})})]})}};var d,g,u;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
