import{j as n}from"./jsx-runtime-DDzbWKUH.js";import{r as t}from"./index-Hemj67b4.js";import{a as y}from"./index-B-lxVbXh.js";import{c as C}from"./index-BpvXyOxN.js";import{u as N}from"./useGridKeyboardNavigation-Baegmm3H.js";import{B as k}from"./Button-Blr1_T7S.js";import{r as O}from"./range-D3V44zw2.js";const _=72,h=24,L=y("item selected"),j={title:"Hooks/useGridKeyboardNavigation"},s={render:()=>{const m=t.useRef(null),d=[2,4,6],[i,I]=t.useState(15),[o,v]=t.useState(4),x=t.useMemo(()=>o*_+2*h,[o]),r=t.useMemo(()=>O(i).map(e=>`${e}.`),[i]),p=t.useCallback(e=>r[e],[r]),{activeIndex:f,onSelectionAction:u}=N({ref:m,numberOfItemsInLine:o,itemsCount:i,getItemByIndex:p,onItemClicked:L,disabledIndexes:d}),g=t.useCallback(e=>()=>u(e),[u]);return n.jsxs("div",{children:[n.jsx("div",{className:"use-grid-keyboard-nav-comp-wrapper",style:{width:x},ref:m,tabIndex:-1,children:r.map((e,a)=>n.jsx(k,{disabled:d.includes(a),onClick:g(a),kind:"secondary",className:C("use-grid-keyboard-nav-item",{"active-item":a===f}),children:e},e))}),n.jsxs("div",{className:"use-grid-keyboard-nav-controls",children:[n.jsxs("div",{children:["Items count:"," ",n.jsx("input",{value:i,onChange:e=>I(Number(e.target.value)),type:"number",min:1})]}),n.jsxs("div",{children:["Number of items in line:"," ",n.jsx("input",{value:o,onChange:e=>v(Number(e.target.value)),type:"number",min:1})]})]})]})},name:"Overview"};var c,l,b;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
