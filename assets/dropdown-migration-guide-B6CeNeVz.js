import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{useMDXComponents as r}from"./index-BfNsOeqz.js";import{M as t}from"./index-xQSt_LUS.js";import{D as i}from"./DiffCodeBlock-CdSfgPcm.js";import{a as l}from"./link-CVYAeutz.js";import"./index-CTZeEbLr.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-CBM6ZyCZ.js";import"./index-CBYycJTn.js";import"./index-BrqHMYbN.js";import"./index-BedKbVpA.js";import"./index-DrFu-skq.js";import"./index-BpvXyOxN.js";import"./withStaticProps-DibdfTK_.js";function s(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Components/Dropdown/Migration Guide"}),`
...
`]}),e.jsx(n.h2,{id:"migration-steps-",children:"Migration Steps 🚀"}),e.jsx(n.h3,{id:"1-update-import-path",children:"1. Update Import Path"}),e.jsx(i,{code:`// In v4, the new Dropdown is the default export from @vibe/core
...
// + import { Dropdown } from "@vibe/core";`}),e.jsx(n.h3,{id:"2-update-option-data-structure",children:"2. Update Option Data Structure"}),e.jsxs(n.p,{children:["The new Dropdown expects options with explicit ",e.jsx(n.code,{children:"label"})," and ",e.jsx(n.code,{children:"value"})," properties:"]}),e.jsx(i,{code:`- const options = [
-   { id: 1, text: "Option 1" },
-   { id: 2, text: "Option 2" }
- ];
+ const options = [
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.code,{children:"withMandatoryDefaultOptions"})})," - Removed. Mark individual options with ",e.jsx(n.code,{children:"removable: false"})," instead (see ",e.jsx(n.a,{href:"#non-removable-options-",children:"Non-Removable Options"}),")"]}),`
...
/>;
`})}),e.jsx(n.h3,{id:"non-removable-options-",children:"Non-Removable Options 📌"}),e.jsxs(n.p,{children:["In the old Dropdown, keeping specific chips from being removed in multi-select mode required the dropdown-level ",e.jsx(n.code,{children:"withMandatoryDefaultOptions"})," prop together with an option-level ",e.jsx(n.code,{children:"isMandatory: true"})," flag. The new Dropdown replaces both with a single, self-describing option-level ",e.jsx(n.code,{children:"removable"})," flag. Set ",e.jsx(n.code,{children:"removable: false"})," on an option to render its chip read-only (no remove button) and protect it from keyboard deletion and clear-all."]}),e.jsx(i,{code:`- <Dropdown
-   multi
-   withMandatoryDefaultOptions
-   options={[
-     { id: 1, text: "Owner", isMandatory: true },
-     { id: 2, text: "Editor" }
-   ]}
- />
+ <Dropdown
...
/>;
`})}),e.jsx(n.h2,{id:"faq-",children:"FAQ ❓"}),e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Q: What happened to the old Dropdown?"}),`
A: The old react-select based Dropdown has been removed in Vibe 4. The new Dropdown (previously available via `,e.jsx(n.code,{children:"@vibe/core/next"}),") is now the default export from ",e.jsx(n.code,{children:"@vibe/core"}),"."]}),e.jsxs(n.p,{children:[e.jsxs(n.strong,{children:["Q: I was importing Dropdown from ",e.jsx(n.code,{children:"@vibe/core/next"}),". What should I change?"]}),`
A: Update your import to use `,e.jsx(n.code,{children:"@vibe/core"})," instead of ",e.jsx(n.code,{children:"@vibe/core/next"}),"."]}),e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Q: Are there any features missing from the new Dropdown?"}),`
...
A: Use the `,e.jsx(n.code,{children:"startElement"})," and ",e.jsx(n.code,{children:"endElement"})," properties on option objects. The new Dropdown supports icons, avatars, indentation, suffixes, and custom elements."]}),e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Q: I'm migrating from Combobox, where should I look?"}),`
A: We have a dedicated `,e.jsx(l,{href:"/?path=/docs/components-combobox-deprecated-migration-guide--docs",children:"Combobox Migration Guide"})," that covers migrating from Combobox to Dropdown box mode."]})]}),`
...
`]}),`
`,e.jsx(n.p,{children:"The new Dropdown represents a significant improvement in accessibility, performance, and developer experience. We're excited to see what you build with it! 🚀"})]})}function y(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{y as default};
