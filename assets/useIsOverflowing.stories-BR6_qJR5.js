import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{r as s}from"./index-CTZeEbLr.js";import{i as u}from"./index-C-yBOSr8.js";import{T as f}from"./Tooltip-WZdDHKve.js";import{F as i}from"./Flex-DIp2zxrn.js";import{T as v}from"./TextField-dWPW1CXv.js";const g="_textContainer_11qne_1",O="_input_11qne_12",l={textContainer:g,input:O},w={title:"Hooks/useIsOverflowing"},t={render:()=>{const x=({text:n})=>{const r=s.useRef(null),o=u({ref:r});return e.jsxs(i,{direction:"column",gap:"medium",align:"start",children:[e.jsxs("div",{children:["Is overflowing: ",o.toString()]}),e.jsx(f,{content:o?n:void 0,children:e.jsx("div",{ref:r,className:l.textContainer,children:n})})]})},[p,d]=s.useState("");return e.jsxs(i,{direction:"column",gap:"small",align:"start",children:[e.jsx(v,{onChange:d,placeholder:"Type text here",className:l.input}),e.jsx(x,{text:p})]})},name:"Overview"};var a,c,m;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => {
