import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{r as k}from"./index-CTZeEbLr.js";import{c as X}from"./createStoryMetaSettingsDecorator-DJeVV-64.js";import{w as H}from"./Modal.stories.helpers-DCOfVGvU.js";import{T,M as F,a as B,b as o,c as i,d as m}from"./TransitionView-CySRzSCA.js";import{M as a}from"./ModalMedia-CUBdKt0p.js";import{M as s}from"./ModalSideBySideLayout-05Mf-T0S.js";import{u as I}from"./useWizard-C20oyI_-.js";import{F as v}from"./Flex-DZptE16X.js";import{T as z}from"./TextField-B5kFFJZt.js";import{L as Y}from"./Label-172IX_ZP.js";import{D as Z}from"./Dropdown-DaF5AdMD.js";import{T as d}from"./Text-DKH6hkNh.js";import{I as $}from"./IconButton-Dzltt4r6.js";import{r as ee}from"./Workspace-DZbcEHYw.js";import{B as P}from"./Button-CbqyrOxW.js";import{L as O}from"./Link-CuijMYlb.js";const r=""+new URL("content-image-iH3LJkS7.png",import.meta.url).href,E=X({component:m}),te={title:"Components/Modal/Side by side modal",component:m,subcomponents:{ModalSideBySideLayout:s,ModalMedia:a,ModalHeader:i,ModalContent:o,ModalFooter:B,ModalFooterWizard:F,TransitionView:T},argTypes:E.argTypes,decorators:E.decorators,parameters:{layout:"fullscreen",docs:{liveEdit:{scope:{mediaImage:r}}}}},C={decorators:[(n,t)=>H(n,{size:"medium",isDocsView:t.viewMode==="docs",allowFullViewInDocs:!0})],render:(n,{show:t,setShow:c,container:l})=>{const p=[e.jsxs(s,{children:[e.jsx(i,{title:"Side by side modal",description:e.jsxs(d,{type:"text1",children:["Modal subtitle, can come with icon ",e.jsx(O,{inheritFontSize:!0,inlineText:!0,text:"and link."})]})}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsxs(s,{children:[e.jsx(i,{title:"Side by side modal",description:e.jsxs(d,{type:"text1",children:["Modal subtitle, can come with icon ",e.jsx(O,{inheritFontSize:!0,inlineText:!0,text:"and link."})]})}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]})],{activeStep:h,direction:u,next:x,back:y,isFirstStep:M,isLastStep:w,goToStep:g}=I({stepCount:p.length}),S=w?"Confirm":"Next";return e.jsxs(m,{id:"modal-sbs",show:t,size:"large",onClose:()=>c(!1),style:{height:400},container:l,...n,children:[e.jsx(T,{activeStep:h,direction:u,children:p}),e.jsx(F,{activeStep:h,stepCount:p.length,onStepClick:g,primaryButton:{text:S,onClick:x},secondaryButton:{text:"Back",onClick:y,disabled:M}})]})},parameters:{docs:{liveEdit:{isEnabled:!1}}}},j={decorators:[(n,t)=>H(n,{size:"medium",isDocsView:t.viewMode==="docs"})],render:(n,{show:t,setShow:c,container:l})=>{const p=[{label:"English",value:"en"},{label:"Hebrew",value:"he"}],h=[e.jsxs(s,{children:[e.jsx(i,{title:"Modal with wizard",description:"Fill in the details"}),e.jsx(o,{children:e.jsxs(v,{direction:"column",gap:"medium",children:[e.jsx(z,{title:"Full name",placeholder:"John Dow"}),e.jsx(z,{title:"Email",placeholder:"Email@monday.com"})]})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsxs(s,{children:[e.jsx(i,{title:"Modal with wizard",description:"Update your settings defenitions"}),e.jsx(o,{children:e.jsxs(v,{direction:"column",gap:"medium",align:"stretch",children:[e.jsx(z,{title:"Fill address",placeholder:"City, street, number"}),e.jsxs(v,{direction:"column",align:"stretch",children:[e.jsx(Y,{labelText:"Language preferences"}),e.jsx(Z,{insideOverflowWithTransformContainer:!0,insideLayerContext:!0,size:"small",placeholder:p[0].label,options:p})]})]})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]})],{activeStep:u,direction:x,next:y,back:M,isFirstStep:w,isLastStep:g,goToStep:S}=I({stepCount:h.length}),L=g?"Confirm":"Next";return e.jsxs(m,{id:"modal-sbs",show:t,size:"large",onClose:()=>c(!1),container:l,style:{height:400},children:[e.jsx(T,{activeStep:u,direction:x,children:h}),e.jsx(F,{activeStep:u,stepCount:h.length,onStepClick:S,primaryButton:{text:L,onClick:y},secondaryButton:{text:"Back",onClick:M,disabled:w}})]})}},f={decorators:[(n,t)=>H(n,{size:"medium",isDocsView:t.viewMode==="docs"})],render:(n,{show:t,setShow:c,container:l})=>e.jsxs(m,{id:"modal-sbs",show:t,renderHeaderAction:e.jsx($,{icon:ee,size:"small",kind:"tertiary","aria-label":"Open Menu"}),size:"large",onClose:()=>c(!1),container:l,style:{height:400},children:[e.jsxs(s,{children:[e.jsx(i,{title:"Modal title"}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsx(B,{primaryButton:{text:"Confirm",onClick:()=>c(!1)},secondaryButton:{text:"Cancel",onClick:()=>c(!1)}})]})},b={render:()=>{const[n,t]=k.useState(!1),[c,l]=k.useState(!1),[p,h]=k.useState(!1),u=k.useRef(null),x=[e.jsxs(s,{children:[e.jsx(i,{title:"Modal title"}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsxs(s,{children:[e.jsx(i,{title:"Modal title"}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsxs(s,{children:[e.jsx(i,{title:"Modal title"}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]})],{activeStep:y,direction:M,next:w,back:g,isFirstStep:S,isLastStep:L,goToStep:Q}=I({stepCount:x.length});return e.jsxs(e.Fragment,{children:[e.jsxs(v,{gap:"large",style:{paddingBlock:40},children:[e.jsx(P,{ref:u,onClick:()=>t(!0),children:"Anchor"}),e.jsx(P,{onClick:()=>l(!0),children:"Center pop"}),e.jsx(P,{onClick:()=>h(!0),children:"Transition"})]}),e.jsxs(m,{id:"modal-sbs-anchor",show:n,anchorElementRef:u,size:"large",onClose:()=>t(!1),style:{height:400},children:[e.jsxs(s,{children:[e.jsx(i,{title:"Modal title"}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsx(B,{primaryButton:{text:"Confirm",onClick:()=>t(!1)},secondaryButton:{text:"Cancel",onClick:()=>t(!1)}})]}),e.jsxs(m,{id:"modal-sbs-center",show:c,size:"large",onClose:()=>l(!1),style:{height:400},children:[e.jsxs(s,{children:[e.jsx(i,{title:"Modal title"}),e.jsx(o,{children:e.jsx(d,{type:"text1",align:"inherit",element:"p",children:"Modal content will appear here, you can custom it however you want, according to the user needs. Please make sure that the content is clear for completing the relevant task."})}),e.jsx(a,{children:e.jsx("img",{src:r,alt:"side by side placeholder",style:{width:"100%",objectFit:"cover"}})})]}),e.jsx(B,{primaryButton:{text:"Confirm",onClick:()=>l(!1)},secondaryButton:{text:"Cancel",onClick:()=>l(!1)}})]}),e.jsxs(m,{id:"modal-sbs-transition",show:p,size:"large",onClose:()=>h(!1),style:{height:400},children:[e.jsx(T,{activeStep:y,direction:M,children:x}),e.jsx(F,{activeStep:y,stepCount:x.length,onStepClick:Q,primaryButton:{text:L?"Confirm":"Next",onClick:w},secondaryButton:{text:"Back",onClick:g,disabled:S}})]})]})}};var A,V,W;C.parameters={...C.parameters,docs:{...(A=C.parameters)==null?void 0:A.docs,source:{originalSource:`{
