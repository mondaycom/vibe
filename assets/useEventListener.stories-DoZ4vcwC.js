import{j as d}from"./jsx-runtime-lwGtIXvq.js";import{r}from"./index-CTZeEbLr.js";import{B as l}from"./Box-BfMxHC0B.js";import{u as c}from"./useEventListener-CkU0kzyk.js";const i={title:"Hooks/useEventListener"},e={render:()=>{const t=r.useRef(null),[u,o]=r.useState(!1),m=r.useCallback(()=>{o(!0)},[o]);return c({ref:t,callback:m,eventName:"mouseenter"}),d.jsx(l,{ref:t,border:!0,rounded:"small",padding:"medium",children:u?"Boom!":"Hover me"})},name:"Overview"};var n,s,a;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: () => {
