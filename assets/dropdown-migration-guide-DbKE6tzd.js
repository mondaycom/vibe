import{j as e}from"./jsx-runtime-DDzbWKUH.js";import{useMDXComponents as r}from"./index-CXa8ra7y.js";import{M as t}from"./index-BiJO_qad.js";import{D as i}from"./DiffCodeBlock-D5IkOmlr.js";import{l}from"./tip-BKixvd9t.js";import"./index-Hemj67b4.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-DSbkyfhr.js";import"./index-DMuH19xN.js";import"./index-D63y3F3s.js";import"./index-BedKbVpA.js";import"./index-DrFu-skq.js";import"./index-BpvXyOxN.js";import"./Flex-DaTSFknt.js";import"./withStaticProps-DibdfTK_.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Components/Dropdown [Alpha]/Migration Guide"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.code,{children:"showSelectedOptions"})})," - ",e.jsx(n.strong,{children:"BREAKING CHANGE"}),": Defaults to ",e.jsx(n.code,{children:"false"}),". In the old Dropdown, selected options were always visible in single select mode."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.code,{children:"showSelectedOptions"})})," - Control selected options visibility (defaults to ",e.jsx(n.code,{children:"false"}),")"]}),`
...
A: Replace `,e.jsx(n.code,{children:"tooltipContent"})," with ",e.jsx(n.code,{children:"tooltipProps"})," for dropdown-level tooltips. The new implementation also supports option-level tooltips via the ",e.jsx(n.code,{children:"tooltipProps"})," property on individual options."]}),e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Q: Why are my selected options hidden from the dropdown list?"}),`
A: The new Dropdown defaults to `,e.jsx(n.code,{children:"showSelectedOptions={false}"})," to improve UX. Set ",e.jsx(n.code,{children:"showSelectedOptions={true}"})," to restore the old behavior."]}),e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Q: Why is my dropdown no longer searchable?"}),`
