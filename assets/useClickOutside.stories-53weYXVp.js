import{j as l}from"./jsx-runtime-DDzbWKUH.js";import{r}from"./index-Hemj67b4.js";import{u as d}from"./index-NFRdg0hY.js";import{B as m}from"./Box-DgmxjabH.js";const C={title:"Hooks/useClickOutside"},e={render:()=>{const[c,t]=r.useState(0),n=r.useRef(null),i=r.useCallback(()=>{t(a=>a+1)},[t]);return d({ref:n,callback:i}),l.jsxs(m,{ref:n,border:!0,rounded:"small",padding:"medium",children:["Click outside ",c]})},name:"Overview"};var o,s,u;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => {
