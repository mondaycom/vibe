import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{useMDXComponents as l}from"./index-BfNsOeqz.js";import{M as c}from"./index-DC9kxK5m.js";import{D as i}from"./DiffCodeBlock-CdSfgPcm.js";import{l as o}from"./tip-CK87uV3P.js";import"./index-CTZeEbLr.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-DAEskHIM.js";import"./index-fc1YjVuE.js";import"./index-BrqHMYbN.js";import"./index-BedKbVpA.js";import"./index-DrFu-skq.js";import"./index-BpvXyOxN.js";import"./Flex-qb9MRXYX.js";import"./withStaticProps-DibdfTK_.js";const t=""+new URL("props-DFVwWYvT.gif",import.meta.url).href,h=""+new URL("package-split-DkGby0Jr.png",import.meta.url).href,a=""+new URL("layers-DGCxNTWT.gif",import.meta.url).href;function d(r){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...r.components},{StorybookLink:s}=n;return s||x("StorybookLink"),e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Migration Guide"}),`
`,e.jsx(n.h1,{id:"vibe-3-migration-guide",children:"Vibe 3 Migration Guide"}),`
`,e.jsx("br",{}),`
`,e.jsx(o,{type:"success",title:"NEW! 🚀 Migration just got INCREDIBLY easy!",emoji:!1,children:e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Skip the manual work and let AI handle your entire Vibe 3 migration!"})," With the ",e.jsx(n.a,{href:"https://vibe.monday.com/?path=/docs/mcp-new--docs",rel:"nofollow",children:`Vibe MCP
server`}),", simply ask your AI assistant: ",e.jsx(n.em,{children:`"Help me migrate this
project from Vibe 2 to Vibe 3"`}),` and watch the magic happen! The MCP will automatically scan your entire codebase,
identify all deprecated components, detect breaking changes, and generate the exact codemod commands you need - all in
seconds.
`,e.jsx("br",{})," ",e.jsx("br",{})," ",e.jsxs(n.strong,{children:[e.jsx(n.a,{href:"https://vibe.monday.com/?path=/docs/mcp-new--docs",rel:"nofollow",children:"Install the MCP →"}),` and turn your migration work into
minutes!`]})]})}),`
...
`]}),`
`]}),e.jsx("ul",{children:e.jsx(i,{code:`"dependencies": {
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- import "monday-ui-react-core/dist/main.css";
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- import Close from "monday-ui-style/src/Icons/Close.svg";
...
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:["Use the ",e.jsx(s,{page:"Text/Text",children:"Text"}),` component for paragraphs, labels, and texts up to
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:["Use the ",e.jsx(s,{page:"Text/Heading",children:"Heading"}),` component the for titles and text from 18px and
...
`]}),e.jsxs(n.p,{children:["For more information, refer to the ",e.jsx(s,{page:"Foundations/Typography",children:"Typography"})," docs."]}),e.jsx(n.h3,{id:"components",children:"Components"}),e.jsxs(n.p,{children:["The following components have been ",e.jsx(n.strong,{children:"removed"})," and are no longer available:"]}),e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Input"})," - use ",e.jsx(s,{page:"Components/TextField",children:"TextField"})," instead"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"EditableInput"})," - use ",e.jsx(s,{page:"Components/EditableText",children:"EditableText"})," instead"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"SearchComponent"})," - use ",e.jsx(s,{page:"Components/Search",children:"Search"})," instead"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"ResponsiveList"})," - use ",e.jsx(s,{page:"Hooks/useIsOverflowing",children:"useIsOverflowing"})," hook instead, to show/hide content based on overflow"]}),`
...
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{page:"Text/Heading",children:"Heading"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{page:"Components/EditableHeading",children:"EditableHeading"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{page:"Components/Search",children:"Search"}),`
`]}),`
`]}),e.jsxs(n.p,{children:["Make sure to import them from ",e.jsx(n.code,{children:"@vibe/core"})," instead of the ",e.jsx(n.code,{children:"/next"})," entry:"]}),e.jsx(i,{code:`- import { Heading, EditableHeading, Search } from "monday-ui-react-core/next";
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Button size="sm">
+ <Button size="small">
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Chips clickable>
+ <Chips onClick={() => {}}>
`})}),e.jsx(n.p,{children:e.jsx(n.strong,{children:"Counter"})}),e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sm"}),", ",e.jsx(n.code,{children:"md"}),", ",e.jsx(n.code,{children:"lg"})," sizes were removed, use ",e.jsx(n.code,{children:"small"}),", ",e.jsx(n.code,{children:"medium"}),", ",e.jsx(n.code,{children:"large"})," respectively:"]}),`
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Counter size="sm">
+ <Counter size="small">
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Icon icon={Heart} clickable onClick={() => {}}>
...
`]}),e.jsx(n.p,{children:e.jsx(n.strong,{children:"Search"})}),e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"type"})," prop was removed. The ",e.jsx(n.code,{children:"Search.types.SQUARE"}),", ",e.jsx(n.code,{children:"ROUND"}),", and ",e.jsx(n.code,{children:"UNDERLINE"})," variants are no longer available"]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"validation"})," prop was removed"]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"wrapperClassName"})," prop was removed, use ",e.jsx(n.code,{children:"className"})," instead"]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"setRef"})," prop was removed, use the standard ",e.jsx(n.code,{children:"ref"})," prop instead"]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"iconNames"})," prop was removed. Use ",e.jsx(n.code,{children:"clearIconLabel"})," for the clear button accessibility label"]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"iconName"})," prop was renamed to ",e.jsx(n.code,{children:"searchIconName"})]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"secondaryIconName"})," prop was renamed to ",e.jsx(n.code,{children:"clearIconName"})]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"activeDescendant"})," prop was renamed to ",e.jsx(n.code,{children:"currentAriaResultId"}),":"]}),`
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Search iconName={MyIcon} secondaryIconName={ClearIcon} activeDescendant="result-1" />
+ <Search searchIconName={MyIcon} clearIconName={ClearIcon} currentAriaResultId="result-1" />
`})}),e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"Search.sizes.SMALL/MEDIUM/LARGE"})," size values were removed, use ",e.jsx(n.code,{children:"small"}),", ",e.jsx(n.code,{children:"medium"}),", ",e.jsx(n.code,{children:"large"})," respectively:"]}),`
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Search size={Search.sizes.SMALL} />
+ <Search size="small" />
`})}),e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"debounceRate"})," default changed from ",e.jsx(n.code,{children:"200"})," to ",e.jsx(n.code,{children:"400"})]}),`
`]}),e.jsx(n.p,{children:"The following components have breaking changes to their API, behavior, or style, as detailed below:"}),e.jsx(n.p,{children:e.jsx(n.strong,{children:"SplitButton"})}),e.jsxs(n.ul,{children:[`
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Steps isOnPrimary>
+ <Steps color="primary">
...
`,e.jsx(n.li,{children:"New readonly style"}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"sm"}),", ",e.jsx(n.code,{children:"md"}),", ",e.jsx(n.code,{children:"lg"})," sizes were removed, use ",e.jsx(n.code,{children:"small"}),", ",e.jsx(n.code,{children:"medium"}),", ",e.jsx(n.code,{children:"large"})," respectively:"]}),`
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <TextField size="sm">
...
`]}),e.jsx("ul",{children:e.jsx(i,{code:`- <Icon icon={Featured}>
+ <Icon icon={Upgrade}>
