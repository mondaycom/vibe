import{j as o}from"./jsx-runtime-lwGtIXvq.js";import{r as e}from"./index-CTZeEbLr.js";import{c as X}from"./createStoryMetaSettingsDecorator-BOvb12cd.js";import{c as k}from"./index-BpvXyOxN.js";import{l as T}from"./tip-CK87uV3P.js";import{m as b}from"./storybook-link-B745udFt.js";import{a as c,M as r,b as Y,L as p,c as _}from"./LegacyModal-CQQ5zS3q.js";import{D as Z}from"./Tooltip-WZdDHKve.js";import{B as V}from"./Button-Dnxv6-sL.js";import{D as $}from"./DialogContentContainer-BeKFb57x.js";import{F as oo}from"./Flex-DIp2zxrn.js";import{H as eo}from"./Heading-BRC2G7st.js";import{t as to}from"./Upgrade-CC_w3yRG.js";import{E as v}from"./EditableHeading-VN0MRvg0.js";const no="_modalDialogBadExample_1wm0f_1",lo="_wrapper_1wm0f_1",ao="_content_1wm0f_6",so="_heading_1wm0f_10",ro="_footer_1wm0f_13",u={modalDialogBadExample:no,wrapper:lo,content:ao,heading:so,footer:ro},d=({title:a="Open modal",setShow:n,openModalButtonRef:l,color:t=void 0,testId:s=void 0})=>o.jsx(V,{onClick:()=>n(!0),ref:l,color:t,"data-testid":s,children:a}),D=({bestPractice:a,modalTitle:n,buttonTitle:l,children:t,hideFooter:s,show:i=!1,openModalTestId:M,...x})=>{const[S,h]=e.useState(i),B=e.useRef(null),m=e.useCallback(()=>{h(!1)},[]),j=d({testId:M,title:l||n,setShow:h,openModalButtonRef:B,color:a?"positive":"negative"}),R=s?null:o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:m,onSecondaryButtonClick:m});return o.jsxs(o.Fragment,{children:[j,o.jsxs(r,{id:"story-book-modal",title:n,triggerElement:B.current,show:S,onClose:m,closeButtonAriaLabel:"close",...x,contentSpacing:!0,children:[t,R]})]})},jo=()=>{const[a,n]=e.useState(!1),l=e.useCallback(()=>{n(!1)},[]),t=e.useCallback(()=>{n(!0)},[]),s=o.jsx($,{style:{width:"500px",margin:"auto"},children:o.jsxs(oo,{className:k(u.modalDialogBadExample,u.content),direction:"column",justify:"start",align:"start",children:[o.jsx(eo,{className:k(u.modalDialogBadExample,u.heading),type:"h2",children:"Dialog title"}),"Dialog content",o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",className:k(u.modalDialogBadExample,u.footer),onPrimaryButtonClick:l,onSecondaryButtonClick:l})]})});return o.jsx(Z,{open:a,onClickOutside:l,wrapperClassName:k(u.modalDialogBadExample,u.wrapper),content:s,children:o.jsx(V,{onClick:t,color:"negative",children:"Click here"})})},Ro=()=>o.jsxs(T,{children:["Set ",o.jsx("code",{children:"alertDialog"})," to ",o.jsx("code",{children:"true"})," in order to allow closing the modal only by the close buttons and not by ESC or by clicking outside."]}),To=()=>o.jsxs(T,{children:["For creating a popover positioned next to other components, like customized menus, check out our"," ",o.jsx(b,{page:"Components/Dialog/Dialog",size:b.sizes.SMALL,children:"Dialog"})," ","component."]}),_o=()=>o.jsxs(T,{title:"Dev tip",children:[`If you wish to implement a dropdown inside a Modal container and need help displaying the dropdown's popovers
    correctly, read more about our dropdown in popovers technical pattern `,o.jsx(b,{page:"Technical patterns/Dropdowns inside pop overs",story:"Modal with damaged dropdown",size:b.sizes.SMALL,children:"here."})]});try{d.displayName="useHelperOpenModalButton",d.__docgenInfo={description:"",displayName:"useHelperOpenModalButton",props:{}}}catch{}try{D.displayName="ModalExampleWrapper",D.__docgenInfo={description:"",displayName:"ModalExampleWrapper",props:{}}}catch{}const E=X({component:r,actionPropsArray:["onClose"]}),co=({onClose:a,...n})=>{const[l,t]=e.useState(!1),s=e.useRef(null),i=e.useCallback(()=>t(!1),[]),M=d({title:n.title,setShow:t,openModalButtonRef:s});return o.jsxs("div",{children:[M,o.jsxs(r,{id:"story-book-modal",title:"Modal title",description:"Subtitle description text goes here",contentSpacing:!0,triggerElement:s.current,show:l,onClose:i,...n,children:[o.jsx(p,{children:o.jsx("p",{children:"Modal content goes here"})}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:i,onSecondaryButtonClick:i})]})]})},io={title:"Components/Modal [Deprecated]",component:r,subcomponents:{ModalHeader:_,ModalContent:p,ModalFooter:Y},argTypes:E.argTypes,decorators:E.decorators},f={render:co.bind({}),name:"Overview"},C={render:()=>{const[a,n]=e.useState(!1),[l,t]=e.useState(!1),[s,i]=e.useState(!1),M=e.useRef(null),x=e.useRef(null),S=e.useRef(null),h=e.useCallback(()=>n(!1),[]),B=e.useCallback(()=>t(!1),[]),m=e.useCallback(()=>i(!1),[]),F=d({title:"Default",setShow:n,openModalButtonRef:M}),j=d({title:"Full size",setShow:t,openModalButtonRef:x}),R=d({title:"Custom size (720px)",setShow:i,openModalButtonRef:S});return o.jsxs(o.Fragment,{children:[F,o.jsxs(r,{id:"storybook-modal-normal",title:"Modal title",triggerElement:M.current,show:a,onClose:h,contentSpacing:!0,children:[o.jsx(p,{children:"Modal content goes here"}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:h,onSecondaryButtonClick:h})]}),j,o.jsxs(r,{id:"storybook-modal-full",title:"Modal title",triggerElement:x.current,show:l,onClose:B,width:"full-width",contentSpacing:!0,children:[o.jsx(p,{children:"Modal content goes here"}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:B,onSecondaryButtonClick:B})]}),R,o.jsxs(r,{id:"storybook-modal-custom",title:"Modal title",triggerElement:S.current,show:s,onClose:m,width:"720px",contentSpacing:!0,children:[o.jsx(p,{children:"Modal content goes here"}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:m,onSecondaryButtonClick:m})]})]})},name:"Sizes"},g={render:()=>{const[a,n]=e.useState(!1),l=e.useRef(null),t=e.useCallback(()=>{n(!1)},[]),s=d({title:"Header with icon",setShow:n,openModalButtonRef:l});return o.jsxs("div",{children:[s,o.jsxs(r,{id:"story-book-modal",title:"Modal header with an Icon",triggerElement:l.current,show:a,onClose:t,closeButtonAriaLabel:"close",contentSpacing:!0,children:[o.jsx(_,{title:"Modal Heading",icon:to,iconSize:32}),o.jsx(p,{children:"Modal content goes here"}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:t,onSecondaryButtonClick:t})]})]})},name:"Modal with icon"},y={render:()=>{const[a,n]=e.useState(!1),l=e.useRef(null),t=e.useCallback(()=>{n(!1)},[]),s=d({title:"Alert dialog",setShow:n,openModalButtonRef:l});return o.jsxs("div",{children:[s,o.jsxs(r,{alertDialog:!0,id:"story-book-modal",title:"Alert modal",triggerElement:l.current,show:a,onClose:t,contentSpacing:!0,children:[o.jsx(p,{children:"Modal content goes here"}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:t,onSecondaryButtonClick:t})]})]})},name:"Alert Modal"},w={render:()=>{const[a,n]=e.useState(!1),l=e.useRef(null),t=e.useCallback(()=>{n(!1)},[]),s=d({title:"Open modal",setShow:n,openModalButtonRef:l});return o.jsxs("div",{children:[s,o.jsxs(r,{id:"story-book-modal",triggerElement:l.current,show:a,onClose:t,closeButtonAriaLabel:"close",contentSpacing:!0,children:[o.jsx(_,{description:"Description text goes here",children:o.jsx(v,{type:v.types.H2,value:"Modal title"})}),o.jsx(p,{children:"Modal content goes here"}),o.jsx(c,{primaryButtonText:"Confirm",secondaryButtonText:"Cancel",onPrimaryButtonClick:t,onSecondaryButtonClick:t})]})]})},name:"Modal with editable title"};var N,H,A;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
