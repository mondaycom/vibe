import{R as e}from"./index-Hemj67b4.js";import{u as l}from"./useWizard-Brh8lqKR.js";import{S as h}from"./Steps-D-0xe4aQ.js";import{H as s}from"./Heading-ILPymVjj.js";import{F as t}from"./Flex-DIvs4XZj.js";import{B as n}from"./Button-DEM-Hn8V.js";const A="_stepper_dhr8e_1",M={stepper:A},T=i=>e.createElement(t,{direction:t.directions.COLUMN,gap:t.gaps.MEDIUM},e.createElement(i,null)),H={title:"Hooks/useWizard",decorators:[T]},p={render:()=>{const{activeStep:i,next:a,back:r,isFirstStep:o}=l({stepCount:5,onFinish:()=>alert("Wizard Completed!")});return e.createElement(e.Fragment,null,e.createElement(s,{weight:s.weights.MEDIUM,type:s.types.H3},"Active Step: ",i),e.createElement(t,{gap:t.gaps.SMALL},e.createElement(n,{kind:n.kinds.TERTIARY,onClick:r,disabled:o},"Back"),e.createElement(n,{onClick:a},"Next")))}},c={render:()=>{const{activeStep:i,next:a,back:r,isFirstStep:o}=l({initialStep:2,stepCount:5});return e.createElement(e.Fragment,null,e.createElement(s,{weight:s.weights.MEDIUM,type:s.types.H3},"Active Step: ",i),e.createElement(t,{gap:t.gaps.SMALL},e.createElement(n,{kind:n.kinds.TERTIARY,onClick:r,disabled:o},"Back"),e.createElement(n,{onClick:a},"Next")))}},d={render:()=>{const{activeStep:i,next:a,back:r,goToStep:o,isFirstStep:B}=l({stepCount:5}),F=[e.createElement("div",null,"Step 1"),e.createElement("div",null,"Step 2"),e.createElement("div",null,"Step 3"),e.createElement("div",null,"Step 4"),e.createElement("div",null,"Step 5")];return e.createElement(e.Fragment,null,e.createElement(h,{className:M.stepper,areNavigationButtonsHidden:!0,isContentOnTop:!0,steps:F,activeStepIndex:i,onChangeActiveStep:(W,b)=>o(b)}),e.createElement(t,{gap:t.gaps.SMALL},e.createElement(n,{kind:n.kinds.TERTIARY,onClick:r,disabled:B},"Back"),e.createElement(n,{onClick:a},"Next")))}};var u,S,m;p.parameters={...p.parameters,docs:{...(u=p.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => {
    const {
      activeStep,
      next,
