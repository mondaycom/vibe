import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{D as N}from"./useGridKeyboardNavigationContext.stories.helpers-D1HJGdM4.js";import{userEvent as S,within as D}from"./index-i7od9_os.js";import{i as oe,r as se,a as E,w,c as re,e as b,p as u,k as _,j as ue,N as m}from"./interactions-utils-CgUjUaHh.js";import{M as i}from"./useMenuItemKeyboardEvents-BaxB-Lgu.js";import{M as n}from"./MenuItem-CGzfGBUb.js";import{F as j}from"./Flex-DZptE16X.js";import{D as a}from"./DialogContentContainer-CnYOKF_Z.js";import{M as l}from"./MenuTitle--v8bq4YK.js";import{M as U}from"./MenuDivider-eEDrEyqC.js";import{l as B}from"./Email-TZY0cRuW.js";import{t as X}from"./Delete-BKCcQViV.js";import{t as J}from"./Info-jvFNh0HS.js";import{t as g,b as Q,r as Y,a as Z,l as me}from"./Invite-BJsiPZ1j.js";import{e as p,l as ee}from"./Settings-C9Ssqg9X.js";import{M as f}from"./MenuGridItem-BfOMQezd.js";const t={TOP_MENU_SUB_MENU_ITEM:"With Sub menu",SUB_MENU_ITEM:"Sub Sub menu",SUB_SUB_MENU_ITEM:"Sub sub item",TOP_MENU_NON_SUB_MENU_ITEM:"Another item"},r="[aria-hidden]",ae=async o=>{const s=ne(o),T=E(s,t.TOP_MENU_SUB_MENU_ITEM,{ignore:r});await S.hover(T);const te=E(s,t.SUB_MENU_ITEM,{ignore:r});await S.hover(te);const ie=await w(()=>D(s).findByText(t.SUB_SUB_MENU_ITEM,{ignore:r}));await re(ie),b(document.activeElement).toHaveTextContent(t.SUB_SUB_MENU_ITEM),await S.hover(E(s,t.TOP_MENU_NON_SUB_MENU_ITEM,{ignore:r})),b(o.queryByText(t.SUB_MENU_ITEM,{ignore:r})).not.toBeInTheDocument(),b(o.queryByText(t.SUB_SUB_MENU_ITEM,{ignore:r})).not.toBeInTheDocument()},le=async o=>{const s=ne(o),T=E(s,t.TOP_MENU_SUB_MENU_ITEM,{ignore:r});await S.click(T),await u(m.DOWN_ARROW),await u(m.DOWN_ARROW),await u(m.RIGHT_ARROW),await w(()=>D(s).findByText(new RegExp(`^${t.SUB_MENU_ITEM}$`),{ignore:r})),_(t.SUB_MENU_ITEM),await u(m.DOWN_ARROW),await u(m.DOWN_ARROW),await u(m.RIGHT_ARROW),await w(()=>D(s).findByText(new RegExp(`^${t.SUB_SUB_MENU_ITEM}$`),{ignore:r})),_(t.SUB_SUB_MENU_ITEM),await u(m.LEFT_ARROW),b(o.queryByText(s,t.SUB_SUB_MENU_ITEM,{ignore:r})).not.toBeInTheDocument(),_(t.SUB_MENU_ITEM),await S.keyboard("{escape}"),b(o.queryByText(s,t.SUB_MENU_ITEM)).not.toBeInTheDocument(),_(t.TOP_MENU_SUB_MENU_ITEM)},Me=oe({tests:[ae,le],afterEach:async()=>{await se()}});function ne(o){return ue(o,"menu")}const ce={title:"Components/Menu/Menu",component:i},de=o=>e.jsxs(i,{...o,children:[e.jsx(n,{title:"Menu item 1"}),e.jsx(n,{title:"Menu item 2",disabled:!0}),e.jsx(n,{title:"Menu item 3"})]}),M={render:de.bind({}),name:"Overview",args:{},parameters:{docs:{liveEdit:{isEnabled:!1}}}},c={render:()=>[e.jsxs(j,{gap:"medium",children:[e.jsx(a,{children:e.jsxs(i,{size:"small",children:[e.jsx(l,{caption:"Small menu"}),e.jsx(U,{}),e.jsx(n,{title:"Menu item 1"}),e.jsx(n,{title:"Menu item 2",disabled:!0}),e.jsx(n,{title:"Menu item 3"})]})},"small"),e.jsx(a,{children:e.jsxs(i,{size:"medium",children:[e.jsx(l,{caption:"Medium menu"}),e.jsx(U,{}),e.jsx(n,{title:"Menu item 1"}),e.jsx(n,{title:"Menu item 2",disabled:!0}),e.jsx(n,{title:"Menu item 3"})]})},"md"),e.jsx(a,{children:e.jsxs(i,{size:"large",children:[e.jsx(l,{caption:"Large menu"}),e.jsx(U,{}),e.jsx(n,{title:"Menu item 1"}),e.jsx(n,{title:"Menu item 2",disabled:!0}),e.jsx(n,{title:"Menu item 3"})]})},"lg")]})],name:"Sizes",args:{size:"small"}},d={render:()=>e.jsx(j,{children:e.jsx(a,{children:e.jsxs(i,{children:[e.jsx(n,{icon:B,title:"Send"}),e.jsx(n,{icon:X,title:"Delete",disabled:!0}),e.jsx(n,{icon:J,title:"More info"})]})})}),name:"Menu with icons"},x={render:()=>e.jsx(j,{children:e.jsx(a,{children:e.jsxs(i,{children:[e.jsx(n,{title:"Menu item without sub menu",icon:g}),e.jsx(n,{title:"With Sub menu",icon:g,children:e.jsxs(i,{children:[e.jsx(n,{icon:B,title:"Send"}),e.jsx(n,{icon:X,title:"Delete",disabled:!0}),e.jsx(n,{icon:J,title:"More info"})]})}),e.jsx(n,{title:"Another item",icon:p})]})})}),name:"Menu with sub menu"},h={render:()=>e.jsx(j,{align:"start",style:{height:"500px"},children:e.jsx(a,{children:e.jsxs(i,{children:[e.jsx(n,{title:"Menu item",icon:ee}),e.jsx(l,{caption:"Top level grid item"}),e.jsx(n,{title:"With Sub menu",icon:g,children:e.jsxs(i,{children:[e.jsx(n,{icon:Q,title:"More info"}),e.jsx(l,{caption:"1st level grid item"}),e.jsx(f,{children:e.jsx(N,{itemsCount:6,numberOfItemsInLine:3,withoutBorder:!0})}),e.jsx(n,{icon:Y,title:"With Sub menu",children:e.jsxs(i,{children:[e.jsx(l,{caption:"2nd level grid item"}),e.jsx(f,{children:e.jsx(N,{itemsCount:6,numberOfItemsInLine:3,withoutBorder:!0})}),e.jsx(n,{icon:Z,title:"Another sub sub item"}),e.jsx(n,{icon:p,title:"More sub sub items"})]})})]})}),e.jsx(n,{title:"Another item",icon:p})]})})}),name:"Menu with grid items and sub menu"},I={render:()=>e.jsx(j,{children:e.jsx(a,{children:e.jsxs(i,{children:[e.jsx(n,{title:"Menu item",icon:ee}),e.jsx(n,{title:"With Sub menu",icon:g,children:e.jsxs(i,{children:[e.jsx(n,{icon:me,title:"Send"}),e.jsx(n,{icon:Y,title:"Sub Sub menu",children:e.jsxs(i,{children:[e.jsx(n,{icon:B,title:"Sub sub item"}),e.jsx(n,{icon:Z,title:"Another sub sub item"}),e.jsx(n,{icon:p,title:"More sub sub items"})]})}),e.jsx(n,{icon:Q,title:"More info"})]})}),e.jsx(n,{title:"Another item",icon:p})]})})}),name:"Menu with 2-depth sub menu",play:Me};var v,C,y;M.parameters={...M.parameters,docs:{...(v=M.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(A=(W=c.parameters)==null?void 0:W.docs)==null?void 0:A.source}}};var R,F,z;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <Flex>
      <DialogContentContainer>
        <Menu>
...
}`,...(z=(F=d.parameters)==null?void 0:F.docs)==null?void 0:z.source}}};var G,$,k;x.parameters={...x.parameters,docs:{...(G=x.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <Flex>
      <DialogContentContainer>
        <Menu>
...
}`,...(k=($=x.parameters)==null?void 0:$.docs)==null?void 0:k.source}}};var L,P,H;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
