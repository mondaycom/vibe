import{j as o}from"./jsx-runtime-DDzbWKUH.js";import{r as s}from"./index-Hemj67b4.js";import{u as m}from"./index-BMFTbhVI.js";import{F}from"./Flex-DaD422-G.js";import{B as g}from"./Button-DzRUwOMA.js";const v={title:"Hooks/useListenFocusTriggers"},e={render:()=>{const[a,t]=s.useState("-"),n=s.useRef(null),i=s.useCallback(d=>{t("mouse")},[]),l=s.useCallback(d=>{t("keyboard")},[]);return m({ref:n,onFocusByMouse:i,onFocusByKeyboard:l}),o.jsxs(F,{direction:"column",gap:"medium",align:"start",children:[o.jsx(g,{ref:n,children:"Focus target"}),o.jsxs("div",{children:["Received focus by: ",a]})]})},name:"Overview"};var r,u,c;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => {
