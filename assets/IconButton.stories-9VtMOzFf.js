import{j as e}from"./jsx-runtime-lwGtIXvq.js";import{I as n}from"./IconButton-Bcd84xLS.js";import{T as o}from"./Text-BwLUW2oo.js";import{F as t}from"./Flex-DYzKCQWz.js";import{A as X}from"./Avatar-RIwmYjIN.js";import{i as q,o as x,u as b}from"./index-CkcRWdy2.js";import{r as N}from"./createComponentTemplate-B08h-OOW.js";import{l as u,V as a,t as i}from"./Workspace-DtDO7RvQ.js";import{r as v}from"./Wand-CS0YeGd1.js";import{t as g}from"./Drag-8qsbRXq_.js";import{a as h}from"./CloseSmall-DUYWL2FE.js";import{B as P}from"./Box-Da56VQkg.js";import{D as G}from"./Divider-Dp6_1p7u.js";import{a as U}from"./link-CVYAeutz.js";import{c as V}from"./createStoryMetaSettingsDecorator-DMY_JaA7.js";import{I as p}from"./Icon-BxXV8fvZ.js";import{B as J}from"./Button-BuWHOp9X.js";const I=""+new URL("person-BWCqTmiy.png",import.meta.url).href,B=V({component:n,iconPropNamesArray:["icon"],actionPropsArray:["onClick"]}),Q=N(n),Y={title:"Components/IconButton",component:n,argTypes:B.argTypes,decorators:B.decorators},r={render:Q.bind({}),args:{id:"overview-icon-button",ariaLabel:"Add",icon:q},parameters:{docs:{liveEdit:{isEnabled:!1}}}},s={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"kinds-primary",icon:u,kind:"primary",ariaLabel:"My primary IconButton"}),e.jsx(n,{id:"kinds-secondary",icon:u,kind:"secondary",ariaLabel:"My secondary IconButton"}),e.jsx(n,{id:"kinds-tertiary",icon:u,kind:"tertiary",ariaLabel:"My tertiary IconButton"})]}),parameters:{docs:{liveEdit:{scope:{Bolt:u}}}}},d={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"sizes-xxs",icon:a,kind:"secondary",size:"xxs",ariaLabel:"My xxs IconButton"},"xxs"),e.jsx(n,{id:"sizes-xs",icon:a,kind:"secondary",size:"xs",ariaLabel:"My xs IconButton"},"xs"),e.jsx(n,{id:"sizes-small",icon:a,kind:"secondary",size:"small",ariaLabel:"My small IconButton"},"small"),e.jsx(n,{id:"sizes-medium",icon:a,kind:"secondary",size:"medium",ariaLabel:"My medium IconButton"},"medium"),e.jsx(n,{id:"sizes-large",icon:a,kind:"secondary",size:"large",ariaLabel:"My large IconButton"},"large")]}),parameters:{docs:{liveEdit:{scope:{Robot:a}}}}},l={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"active-primary",icon:i,kind:"primary",ariaLabel:"My small active IconButton",active:!0}),e.jsx(n,{id:"active-secondary",icon:i,kind:"secondary",ariaLabel:"My active medium IconButton",active:!0}),e.jsx(n,{id:"active-tertiary",icon:i,kind:"tertiary",ariaLabel:"My active large IconButton",active:!0})]}),parameters:{docs:{liveEdit:{scope:{Doc:i}}}}},c={render:()=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-evenly",alignItems:"center",width:"100%"},children:[e.jsx(n,{id:"disabled-primary",icon:i,kind:"primary",ariaLabel:"My small disabled IconButton",disabled:!0,disabledReason:"This function is not available"}),e.jsx(n,{id:"disabled-secondary",icon:i,kind:"secondary",ariaLabel:"My disabled medium IconButton",disabled:!0,disabledReason:"This function is not available"}),e.jsx(n,{id:"disabled-tertiary",icon:i,kind:"tertiary",ariaLabel:"My disabled large IconButton",disabled:!0,disabledReason:"This function is not available"})]}),parameters:{docs:{liveEdit:{scope:{Doc:i}}}}},m={render:()=>e.jsx(P,{border:!0,rounded:"medium",style:{width:"50%"},children:e.jsxs(t,{direction:"column",align:"start",children:[e.jsxs(t,{gap:"small",style:{padding:"var(--sb-spacing-small)"},children:[e.jsx(p,{icon:g}),e.jsx(o,{type:"text1",children:"Widget name"}),e.jsx(n,{id:"toolbar-filter-button",icon:v,ariaLabel:"Filter the widget by everything",size:"small"})]}),e.jsx(G,{withoutMargin:!0}),e.jsx("div",{style:{height:"200px",width:"100%",backgroundColor:"var(--sb-primary-background-hover-color)"}})]})}),parameters:{docs:{liveEdit:{scope:{Drag:g,Filter:v}}}},name:"Icon button as toolbar button"},y={render:()=>e.jsxs(t,{gap:"medium",style:{width:"100%"},children:[e.jsx(P,{border:!0,rounded:"small",paddingX:"large",style:{width:"100%"},children:e.jsxs(t,{justify:"start",gap:"large",style:{height:"94px"},children:[e.jsxs(t,{direction:"column",justify:"center",style:{color:"var(--sb-icon-color)"},children:[e.jsx(p,{icon:b,iconSize:40}),e.jsx(o,{type:"text1",id:"monday-recycle-bin-title",children:"Item"})]}),e.jsx(G,{direction:"vertical"}),e.jsx(X,{size:"large",src:I,type:"img"}),e.jsxs(t,{direction:"column",align:"start",ariaLabelledby:"monday-recycle-bin-title",style:{flexGrow:1},children:[e.jsxs(t,{gap:"xs",children:[e.jsx(U,{withoutSpacing:!0,href:"",children:"Hadas Farhi"}),e.jsx("span",{children:"deleted the item"}),e.jsx(o,{type:"text1",element:"span",weight:"medium",children:"Hello World"}),e.jsx("span",{children:"from the board"})]}),e.jsx(o,{type:"text1",element:"span",weight:"medium",children:"Tasks"}),e.jsxs(t,{gap:"xs",children:[e.jsx(p,{icon:x}),e.jsx(o,{weight:"medium",children:"13m"}),e.jsx(o,{children:"(Available for restore in the next 1M)"})]})]}),e.jsx(J,{id:"restore-button",ariaLabel:"Restore deleted item",children:"Restore"})]})}),e.jsx(n,{id:"close-recycle-button",icon:h,size:"small",ariaLabel:"Remove from Recycle bin"})]}),parameters:{docs:{liveEdit:{scope:{person1:I,Item:b,Time:x,CloseSmall:h}}}},name:"Icon button as close button"};var j,f,k;r.parameters={...r.parameters,docs:{...(j=r.parameters)==null?void 0:j.docs,source:{originalSource:`{
