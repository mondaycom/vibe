import{j as o}from"./jsx-runtime-DDzbWKUH.js";import{r as d}from"./index-Hemj67b4.js";import{u as b}from"./index-DxqC8EIR.js";import{F as p}from"./Flex-DyEHjGyy.js";import{T as x}from"./TextField-DtjpTriO.js";import{B as r}from"./Button-bpAINS_f.js";const B="_controlButton_mhy6u_1",F="_focusLabel_mhy6u_6",t={controlButton:B,focusLabel:F},_={title:"Hooks/useSetFocus"},e={render:()=>{const a=()=>{},i=()=>{},n=d.useRef(null),{isFocused:s,focus:m,blur:f}=b({ref:n,focusCallback:a,blurCallback:i});return o.jsxs(p,{direction:"column",children:[o.jsx(x,{ref:n,placeholder:"Input..."}),o.jsx(r,{onClick:m,className:t.controlButton,children:"Focus"}),o.jsx(r,{onClick:f,className:t.controlButton,children:"Blur"}),o.jsxs("div",{className:t.focusLabel,children:["Is focused: ",s==null?void 0:s.toString()]})]})},name:"Overview"};var c,l,u;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    const focusCallback = () => {};
    const blurCallback = () => {};
