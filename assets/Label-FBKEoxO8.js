...
`,e.jsx(m,{componentsNames:["Tooltip","Counter","Chips"]})]})}function Oe(i={}){const{wrapper:o}={...c(),...i.components};return o?e.jsx(o,{...i,children:e.jsx(d,{...i})}):d(i)}function s(i,o){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{Oe as default};
