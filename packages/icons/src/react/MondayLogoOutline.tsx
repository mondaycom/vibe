...
export interface EZCorpLogoOutlineProps extends React.SVGAttributes<SVGElement> {
size?: string | number;
}
const EZCorpLogoOutline: React.FC<EZCorpLogoOutlineProps> = ({size, ...props}) => (
...
EZCorpLogoOutline.displayName = 'EZCorpLogoOutline';
export default EZCorpLogoOutline;
/* tslint:enable */
/* eslint-enable */
