...
The Attention box component consist of enter animation prop to increase user attention. Is highly recommended to use a delay before the attention box entry motion once the page is fully loaded.
