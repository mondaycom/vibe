...
The default Attention Box presents content in multiple lines, with or without title. It can include a link, a button, or both. If the text exceeds the available space it display an ellipsis and tooltip, when necessary.
...
<RelatedComponents componentsNames={[ALERT_BANNER, TIPSEEN, TOOLTIP]} />
