...
import { Frame, ComponentRules, RelatedComponents, UsageGuidelines } from "vibe-storybook-components";
import {
  ALERT_BANNER,
  TOOLTIP,
  TIPSEEN
  ...
  rules={[
    ...
    },
    {
      ...
      negative: {
        ...
        description:
          "Don't use when the supporting text is brief and can be explained in just a few words. Use a tooltip instead."
      }
    }
  ]}
/>
