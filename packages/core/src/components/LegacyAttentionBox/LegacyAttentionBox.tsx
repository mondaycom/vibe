...
import { AttentionBoxType as AttentionBoxTypeEnum } from "./LegacyAttentionBoxConstants";
import { AttentionBoxType } from "./LegacyAttentionBox.types";
import { SubIcon, VibeComponentProps, ElementContent, withStaticPropsWithoutForwardRef } from "../../types";
import Text from "../Text/Text";
import Flex from "../Flex/Flex";
import styles from "./LegacyAttentionBox.module.scss";

export interface LegacyAttentionBoxProps extends VibeComponentProps {
...
interface LegacyAttentionBoxStaticProps {
  types: typeof AttentionBoxTypeEnum;
  iconTypes: typeof IconTypeEnum;
}

Object.assign(LegacyAttentionBox, {
  displayName: "AttentionBox"
});

export default withStaticPropsWithoutForwardRef<LegacyAttentionBoxProps, LegacyAttentionBoxStaticProps>(
  LegacyAttentionBox,
  {
