...
On dark theme, our menus have a stroke instead of the drop shadow. This design created to enhance better visibility and differentiation between the menu layers. The stroke is added automatically while developing the feature.

<Canvas className={"dark-app-theme"} of={MenuStories.MenuOnDarkTheme} />
