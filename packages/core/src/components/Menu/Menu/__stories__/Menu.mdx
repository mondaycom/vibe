...
On dark theme, our menus have a stroke instead of the drop shadow. This design created to enhance better visibility and differentiation between the menu layers.

<Canvas theme="dark" of={MenuStories.MenuOnDarkTheme} />
