...
import { Example } from "vibe-storybook-components";
...
import tooltip2 from "./tooltip2.svg";
...
<Example>
  <img src={tooltip1} alt="Example of link on inverted surface" />
  <img src={tooltip2} alt="Example of link on inverted surface on hover" />
</Example>
