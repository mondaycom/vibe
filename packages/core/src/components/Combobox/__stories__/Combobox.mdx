...
### Combobox on dark theme

On dark theme, our combobox have a stroke instead of the drop shadow. This design created to enhance better visibility and differentiation between the background layer to the combobox itself.

<Canvas className={"dark-app-theme"} of={ComboboxStories.ComboboxOnDarkTheme} />
