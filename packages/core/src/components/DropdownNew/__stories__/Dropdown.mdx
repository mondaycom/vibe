...
<UsageGuidelines
  guidelines={[
    ...
    "Use `required` prop to indicate when the dropdown is required, which will be communicated to assistive technologies.",
    "Use `error` prop to indicate error states, which will be communicated to assistive technologies.",
    "Use `helperText` prop to provide additional context or instructions for users.",
