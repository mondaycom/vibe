...
### Dialog on dark theme

On dark theme, our dialog have a stroke instead of the drop shadow. This design created to enhance better visibility and differentiation between the background layer to the dialog itself.

<Canvas theme="dark" of={DialogStories.DialogOnDarkTheme} />
