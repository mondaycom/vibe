...
### Dropdown on dark theme

On dark theme, our dropdown-menu have a stroke instead of the drop shadow. This design created to enhance better visibility and differentiation between the background layer to the menu itself.

<Canvas className={"dark-app-theme"} of={DropdownStories.DropdownOnDarkTheme} />
