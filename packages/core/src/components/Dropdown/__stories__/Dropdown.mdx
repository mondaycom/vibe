...
The Dropdown component exposes the following ARIA roles and attributes for testing and accessibility:

### Default Roles
- `combobox` - The main dropdown container
- `listbox` - The dropdown options list
- `option` - Individual dropdown options

### Additional Attributes
- `aria-label` - Default label for the dropdown menu ("Dropdown menu")
- `aria-expanded` - Indicates if the dropdown is open
- `aria-haspopup` - Indicates the element has a popup
- `aria-controls` - Links the dropdown trigger to its menu

### Example Testing Code
```jsx
// ✅ Recommended - Using roles
