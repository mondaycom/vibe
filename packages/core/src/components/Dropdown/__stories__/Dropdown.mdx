...
<UsageGuidelines
  guidelines={[
    ...
    <>
      Use <code>inputAriaLabel</code> prop when you need to provide a specific accessible name for the input field.
    </>,
    <>
      Use <code>menuAriaLabel</code> prop when you need to provide a custom accessible name for the dropdown menu.
    </>,
    <>
      Use <code>menuId</code> prop to provide a specific ID for the menu container for screen reader navigation.
    </>,
    <>
      Use <code>tabIndex</code> prop for custom keyboard navigation order when needed.
    </>
  ]}
/>
