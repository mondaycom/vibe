...
The expandable row content is fully customizable and can be used to display additional information about a row when it is expanded.

<Canvas of={TableStories.ExpandableRow}/>
