...
```js
import { AlertBanner } from "monday-ui-react-core";
```
...
<ComponentRules
  rules={[
    ...
    },
    {
      positive: {
        component: (
          <AlertBanner className="monday-storybook-alert-banner_medium-container" backgroundColor="negative">
      ...
      negative: {
        component: (
          <div className="monday-storybook-alert-banner_column-wrapper">
            <AlertBanner backgroundColor="negative" className="monday-storybook-alert-banner_medium-container">
              <AlertBannerText text="No connection" />
              <AlertBannerLink text="Learn more" href="https://monday.com" />
    ...
    },
    {
      positive: {
        component: (
          <AlertBanner backgroundColor="dark" className="monday-storybook-alert-banner_medium-container">
            <AlertBannerText text="Join us at Elevate!" />
            <AlertBannerLink text="RSVP now" href="https://monday.com" />
          </AlertBanner>
        ),
