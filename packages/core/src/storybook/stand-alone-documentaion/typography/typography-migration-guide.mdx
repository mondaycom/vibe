...
import { TipUseComponent } from "./typograpghy.stories.helpers";
...
<UsageGuidelines
  guidelines={[
    <>
      ...
      16px. It includes 2 variants: <code>Text1</code>, <code>Text2</code> and <code>Text3</code>. Each variant has a
...
For a more detailed breakdown of the variants see the <Link href="/?path=/docs/foundations-typography--docs#type-styles" withoutSpacing target="_parent">Type Styles table</Link>.
