...
Get comprehensive metadata for any Vibe component, including props, types, and more.
...
Browse all available public components in the Vibe ecosystem.
...
Access React implementation examples and best practices for Vibe components.
...
Explore the complete Vibe icon library with smart filtering and search capabilities.
...
Access design tokens from the `monday-ui-style` package for consistent styling using Vibe's tokens.
...
Advanced project analysis for Vibe 2 → Vibe 3 migration.

This intelligent tool analyzes your entire project and provides:
...
[![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/install-mcp?name=vibe&config=eyJjb21tYW5kIjoibnB4IEB2aWJlL21jcCJ9)
