...
Flex spacing is a form of spacing that creates equal distance between components. EZDS provides a flex component that utilizes the spacing scale to set consistent spacing between items.
