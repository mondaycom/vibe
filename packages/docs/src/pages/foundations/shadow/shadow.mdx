...
Virtual light in EZCORP platform always comes from the top and creates a shadows from layout and UI elements like in real world.
Shadows used to create the scenes of hierarchy and elevation withing the UI and layout.

<img src={shadowsSketch} className="ezds-storybook-shadow_overview-image" alt="" />
