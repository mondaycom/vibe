...
<Tip title="New List Available" emoji="🚀">
  This component is deprecated. A new List component is available with improved keyboard navigation, accessibility features, and a cleaner API.
  Check out the <StorybookLink page="Components/List [New]">new List component</StorybookLink>.
</Tip>
