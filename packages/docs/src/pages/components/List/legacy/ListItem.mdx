...
<Tip title="New ListItem Available" emoji="🚀">
  This component is deprecated. A new ListItem component is available with a cleaner, data-driven API.
  Check out the <StorybookLink page="Components/List [New]/ListItem">new ListItem component</StorybookLink>.
</Tip>
