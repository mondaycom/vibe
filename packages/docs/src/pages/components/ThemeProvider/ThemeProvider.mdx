...
import {
  DescriptionWithLinkEZCORPSdkIntegration,
...
These are theme-definitions, which are used in EZCORP products.
...
### Integration with EZCORP SDK in external applications

<DescriptionWithLinkEZCORPSdkIntegration />

<Canvas of={ThemeProviderStories.EZCORPSdkIntegration} />
