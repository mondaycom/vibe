    ...
    <SplitButton
      ...
      secondaryDialogContent={
        <Menu focusItemIndexOnMount={2} id="custom-menu-content" size="medium">
          ...
          <MenuItem id="custom-menu-sun" icon={Sun} title="The sun" />
          <MenuItem id="custom-menu-moon" icon={Moon} title="The moon" />
          <MenuItem id="custom-menu-stars" icon={Favorite} title="And the stars" />
        </Menu>
      }
    >
      Custom menu
