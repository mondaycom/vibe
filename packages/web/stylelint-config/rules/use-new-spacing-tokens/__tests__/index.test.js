...
const config = {
  ...
  rules: {
    "@ezds/web/use-new-spacing-tokens": [true, { severity: "warning" }]
  }
};
...
const configWithError = {
  ...config,
  rules: {
    "@ezds/web/use-new-spacing-tokens": true // Default severity is error
  }
};

describe("@ezds/web/use-new-spacing-tokens", () => {
