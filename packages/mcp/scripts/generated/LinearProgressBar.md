...
```tsx
lineProgressBarTemplate = (args: LinearProgressBarProps) => {
...
```tsx
<LinearProgressBar className="linear-progress-bar_small-wrapper" value={50} indicateProgress valueSecondary={65} size="large" />
```
