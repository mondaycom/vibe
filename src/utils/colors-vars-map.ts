export const colorsMap = [
  ...
  { color: "--text-color-fixed-light", description: "Use for text which should be light in any theme" },
  { color: "--text-color-fixed-dark", description: "Use for text which should be dark in any theme" },
  // states
  {
