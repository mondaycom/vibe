import { Story, Canvas, Meta, Link } from "@storybook/addon-docs";
...
Hook for controlling focus on a specific component (e.g., Input).
  ...
  <FunctionArgument name="options" type="Object">
    <FunctionArgument
      ...
      description={
        <>
          A React{" "}
          <Link to="https://react.dev/reference/react/useRef">
            ref
          </Link>{" "}
          object.
        </>
