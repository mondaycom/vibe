...
import { EditableInput, Flex, Label, Tooltip } from "../../../components";
      ...
      const ComponentWithOverflow = ({ text }) => {
        ...
        return (
          <Flex direction={Flex.directions.COLUMN} gap={Flex.gaps.MEDIUM} align={Flex.align.START}>
            <Label
              color={isOverflowing ? Label.colors.NEGATIVE : Label.colors.POSITIVE}
              text={isOverflowing ? "Overflowing" : "No overflowing"}
