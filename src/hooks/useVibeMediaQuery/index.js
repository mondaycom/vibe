...
import { MEDIA_QUERY_SIZES, LARGE, SMALL1, XLARGE, MEDIUM1, MEDIUM2, SMALL2 } from "utils/media-query-utils";

export default function useVibeMediaQuery() {
  const [mediaSize, setMediaSize] = useState(SMALL1);
  const [isSmall1, isSmall2, isMedium1, isMedium2, isLarge, isXLarge] = useMediaQuery(MEDIA_QUERY_SIZES);
