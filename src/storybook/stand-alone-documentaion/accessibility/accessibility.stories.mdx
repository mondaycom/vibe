...
import {ComponentName, Frame, UnstyledList, UnstyledListItem} from "../../components";
...
<Tip title="Use color contrast tools for code and design">To check color contrast in design use <a
    href="https://www.figma.com/community/plugin/748533339900865323/Contrast" target="_blank">Contrast figma
    plugin</a> and inspect elements accessibility tab for live code verification</Tip>
