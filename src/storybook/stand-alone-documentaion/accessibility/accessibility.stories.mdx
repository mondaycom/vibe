...
import { ComponentName, Frame, Link, RelatedComponents, Tip, UnstyledList, UnstyledListItem } from "../../components";
import { PrinciplesAccessibility } from "./principles/principlesAccessibility";
...
<ComponentName withFoundationBackground>Accessibility</ComponentName>
...
<Tip title="Get our Accessibility checklist">
  <Link href={accessibilityCheckList} target="_blank">
    Download
  </Link>
...
<Tip title="Use color contrast tools for code and design">
  ...
  <Link href="https://www.figma.com/community/plugin/748533339900865323/Contrast" target="_blank">
...
<UnstyledList>
  <UnstyledListItem>
    ...
    cognitive impairments. For example: JAWS and NVDA on windows machines, VoiceOver for MacOS.
  </UnstyledListItem>
