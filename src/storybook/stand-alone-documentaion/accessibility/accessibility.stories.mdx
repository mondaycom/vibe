...
<Tip title="Get our Accessibility checklist">Download our accessibility checklist file.</Tip>

## Accessibility principles
<PrinciplesAccesability/>

## Color contrast
__Text Color Contrast__<br/>
...
<UnstyledList>
    ...
    <UnstyledListItem>Voice recognition software and selection switches for people who cannot use a keyboard or a mouse. For example: Dragon Naturally Speaking</UnstyledListItem>
</UnstyledList>
