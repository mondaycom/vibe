...
__Non-Text Color Contrast__<br/>
...
__Information Images__ are all images that convey important information and communicate information visually:
...
__Decorative Images__ such as borders, empty states, background ambience images:
