...
Except for:
Large Text - at least 18pt (typically 24px) or 14pt (typically 18.66px) and bold must have a contrast ratio of at least 3:1<br/>
Incidental - inactive user interface (disabled items), decorative (icons, Illustartions) non-visible, insignificant part of a picture<br/>
