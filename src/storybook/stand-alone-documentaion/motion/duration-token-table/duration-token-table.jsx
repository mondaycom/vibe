...
export const DurationTokenTable = () => {
  ...
  const tbodyData = [
    {
      id: "1",
      items: ["motion-productive-small", "Micro-Interactions ", "70ms"]
    },
    {
      id: "2",
    ...
    {
      id: "3",
      items: ["motion-productive-Large", "expansions,  distance movment", "150ms"]
    },
    { id: "4", items: ["motion - expressive - short", "Notification - elastic / bounce","250ms"] },
    { id: "5", items: ["motion - expressive - Large", "Notification - elastic/bounce + movment", "400ms"] }
  ];
  return (
    <div>
