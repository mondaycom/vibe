...
import { Link, RelatedComponents } from "../../components";
...
<img src={typographyExample1} alt="" className="monday-storybook-typography_first-image"/>
<img src={typographyExample2} alt="" />
