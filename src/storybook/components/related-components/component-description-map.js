...
descriptionComponentsMap.set(MULTI_STEP_INDICATOR, <MultiStepIndicatorDescription />);
...
descriptionComponentsMap.set(STEPS, <StepsDescription />);
...
descriptionComponentsMap.set(LINEAR_PROGRESS_BAR, <LinearProgressBarDescription />);
