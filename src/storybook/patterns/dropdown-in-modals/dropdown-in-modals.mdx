...
<Canvas>
  <Story of={DropdownInModalsStories.ModalWithDamagedDropdown} />
</Canvas>
...
<Canvas>
  <Story of={DropdownInModalsStories.MenuPosition} />
</Canvas>
...
<Canvas>
  <Story of={DropdownInModalsStories.InsideOverflowContainer} />
</Canvas>
...
<Canvas>
  <Story of={DropdownInModalsStories.InsideOverflowWithTransformContainer} />
</Canvas>
