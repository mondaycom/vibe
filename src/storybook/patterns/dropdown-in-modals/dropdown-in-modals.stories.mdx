...
import { RelatedComponents, Tip } from "vibe-storybook-components";
...
To handle straightforward scenarios of displaying dropdowns inside a container with relevant overflow styles, you can set <code>menuPosition</code> prop to <code>Dropdown.menuPosition.FIXED</code>.
...
<Tip type={Tip.types.WARNING} emoji={"⚠️"} title="Known issue">
  ...
  space. We recommend checking using other options instead of this one.
</Tip>
...
## Solution 4: popupsContainerSelector - universal solution
