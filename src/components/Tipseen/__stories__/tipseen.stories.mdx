...
<Tip title="Check yourself">If you need to provide additional information about a component, use the <Link href="/?path=/docs/dialogs-and-pop-ups-tooltip--overview" size={Link.sizes.SMALL} withoutSpacing>Tooltip</Link> or <Link href="/?path=/docs/feedback-attentionbox--overview" size={Link.sizes.SMALL} withoutSpacing>Attention box.</Link></Tip>
  ...
  rules={[
    {
      ...
      negative: {
        ...
        description:<>Don’t use tipseen to provide additional information on a familiar UI. Use a <Link href="/?path=/docs/dialogs-and-pop-ups-tooltip--overview" withoutSpacing>Tooltip</Link> or <Link href="/?path=/docs/feedback-attentionbox--overview" withoutSpacing>Attention box</Link> instead.</>
      }
    }
  ]}
/>
