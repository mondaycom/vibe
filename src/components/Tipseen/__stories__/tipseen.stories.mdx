...
import { video, picture } from "./assets";
...
<Meta
  ...
  component={Tipseen}
  subcomponents={{ TipseenMedia, TipseenImage, TipseenContent, TipseenWizard }}
...
<Canvas>
  <Story name="Tipseen with custom media">
    {() => {
      return (
        <Tipseen
          // The modifier's purpose is to prevent the tipseen from being displayed when the user scrolls the story upwards / downwards.
          ...
          content={
            <>
              <TipseenMedia>
                <video autoPlay muted loop src={video} style={{ width: "100%" }} />
              </TipseenMedia>
...
<Canvas>
  <Story name="Floating Tipseen" height="500px">
    {() => {
      return (
        <Tipseen
          closeButtonTheme={Tipseen.closeButtonThemes.DARK}
      ...
      negative: {
        ...
        description: (
          <>
            ...
            <Link href="/?path=/docs/popover-tooltip--overview">Tooltip</Link>
            or
            <Link href="/?path=/docs/feedback-attentionbox--overview">Attention box</Link>
            instead.
          </>
        )
      }
