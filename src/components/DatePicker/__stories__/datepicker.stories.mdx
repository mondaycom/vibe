...
import { TEXT_FIELD,DROPDOWN,DIALOG_CONTENT_CONTAINER } from "../../../storybook/components/related-components/component-description-map";
...
export const DatePicker = props => {
  ...
  return <DialogContentContainer className={'datepicker-dialog-content-container'}>
    {props.range ? (
