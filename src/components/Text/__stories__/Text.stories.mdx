...
<Canvas>
  <Story name="Links inside running text">
    <Flex direction={Flex.directions.COLUMN} align={Flex.align.START} gap={Flex.gaps.SMALL}>
      <Text>
        This is the story of a <Link href="/?path=/docs/foundations-typography--page">link</Link> inside running text.
      </Text>
      <Text
        element="div"
        ellipsis={false}
        ...
        color={Text.colors.ON_PRIMARY}
      >
        This is the story of a <Link href="/?path=/docs/foundations-typography--page">link</Link> inside running text on a
        primary color
      </Text>
      <Text
        element="div"
        ...
        color={Text.colors.ON_INVERTED}
      >
        This is the story of a <Link href="/?path=/docs/foundations-typography--page">link</Link> inside running text on an
        inverted color
      </Text>
    </Flex>
  </Story>
