...
<Meta title="Text/Text [beta]" component={Text} argTypes={metaSettings.argTypes} decorators={metaSettings.decorators} />
...
<Canvas>
  <Story name="Overflow" play={textOverflowSuite} parameters={{ status: "new" }}>
    <Flex
      direction={Flex.directions.COLUMN}
