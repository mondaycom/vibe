    ...
    {() => {
      const options = useMemo(() => [
        ...
        { id: "6", label: "Mobile", categoryId: "workspace" },
          { id: "11", label: "Favorites", categoryId: "favorites" },
          { id: "12", label: "Main workspace", categoryId: "favorites" },
          { id: "13", label: "Client Foundations", categoryId: "favorites" },
          { id: "14", label: "Design", categoryId: "favorites" },
          { id: "15", label: "Marketing Cluster", categoryId: "favorites" },
          { id: "16", label: "Mobile", categoryId: "workspace" }
      ], []);
      ...
      return (
        <Flex gap={Flex.gaps.SMALL}  style={{width:"100%"}} justify={Flex.justify.SPACE_AROUND} align={Flex.align.START} >
          <StoryDescription description="Categories without divider" vertical>
            <DialogContentContainer style={{height: "200px"}} render>
              <Combobox options={options} categories={undefined} placeholder="Placeholder text here" renderOnlyVisibleOptions/>
            </DialogContentContainer>
          </StoryDescription>
          <StoryDescription description="Categories with divider" vertical>
            <DialogContentContainer>
              <Combobox options={options} categories={categories} withCategoriesDivider placeholder="Placeholder text here" />
            </DialogContentContainer>
          </StoryDescription>
        </Flex>
      )
  ...
  <Story name="With Button">
    {() => {
      ...
      return (
        <DialogContentContainer>
          <Combobox options={options} placeholder="Placeholder text here" />
          <Button kind={Button.kinds.TERTIARY} className="combobox-stories-styles_btn" leftIcon={Edit}>Edit</Button>
        </DialogContentContainer>
      )
    }}
  </Story>
  ...
  rules={[
    {
      ...
      negative: {
        ...
        description:<>Don’t use comboxbox if you have less than 5 list items. If it's not complex enough for a combo box, use a <Link href="/?path=/docs/inputs-radio-button--overview" withoutSpacing>Radio button</Link> or <Link href="/?path=/docs/inputs-dropdown--overview" withoutSpacing>Dropdown.</Link></>
      }
    },
    {
      className: "combobox-stories-styles_big-figure",
    ...
    {() => {
        const options = useMemo(
          () => [
            ...
            { id: "Rotem Dekel", label: "Rotem Dekel", src: person2, type: Avatar.types.IMG, position: "(Product Designer)", categoryId: "suggestedPeople" },
            { id: "Netta Muller", label: "Netta Muller", src: person3, type: Avatar.types.IMG, position: "(Brand Designer)", categoryId: "suggestedPeople" }
          ],
          []
        );
        const categories = useMemo(
       ...
       return (<Flex style={{ width: "100%", height: "270px" }} justify={Flex.justify.CENTER} align={Flex.align.START}>
        <Dialog
          content={() => (
