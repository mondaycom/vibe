...
<Canvas>
    <Story name="With window optimization">
        {() => {
            const options = useMemo(() => [
            ...
            return (
                <Flex gap={Flex.gaps.SMALL}  style={{width:"100%"}} justify={Flex.justify.SPACE_AROUND} align={Flex.align.START} >
                    <StoryDescription description="Window optimization without categories" vertical>
                        <DialogContentContainer style={{height: "200px"}}>
                            <Combobox options={options} renderOnlyVisibleOptions placeholder="Placeholder text here" />
                        </DialogContentContainer>
                    </StoryDescription>
                    <StoryDescription description="Window optimization with categories" vertical>
                        <DialogContentContainer style={{height: "200px"}}>
                            <Combobox options={options} categories={categories} renderOnlyVisibleOptions placeholder="Placeholder text here" />
                        </DialogContentContainer>
                    </StoryDescription>
                </Flex>
            )
