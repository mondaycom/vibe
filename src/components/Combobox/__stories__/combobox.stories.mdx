...
import { onSelectClearsFilterTest } from "../__tests__/Combobox.interactions";
...
<Canvas>
  <Story name="With optionRenderer">
    {() => {
      ...
      const optionRenderer = option => <div><Icon icon={Person}/> I can render anything with {option.label}</div>;
      return (
        <DialogContentContainer style={{height:"200px"}}>
            ...
            return (
                <Flex gap={Flex.gaps.SMALL} style={{width:"100%"}} justify={Flex.justify.SPACE_AROUND} align={Flex.align.START} >
                    ...
                    <StoryDescription
                        ...
                        <div style={{width: "300px"}}>
                            <DialogContentContainer style={{height: "200px"}}>
                                <Combobox options={options} renderOnlyVisibleOptions categories={categories} placeholder="Placeholder text here" />
                            </DialogContentContainer>
                        </div>
                    </StoryDescription>
                </Flex>
