...
import { Update, Time, Upgrade, ThumbsUp, Wand, Person, Form } from "../../Icon/Icons";
...
<Canvas>
  <Story name="With categories">
    {() => {
      ...
      return (
        <Flex gap={50} style={{ width: "100%" }} justify={Flex.justify.START} align={Flex.align.START}>
...
You can also provide custom colors for your headings.

<Canvas>
  <Story name="With colored categories">
    {() => {
      const options = useMemo(
        () => [
          { id: "1", label: "Apple", categoryId: "red" },
          { id: "2", label: "Banana", categoryId: "yellow" },
          { id: "3", label: "Submarine", categoryId: "yellow" },
          { id: "4", label: "Ruby", categoryId: "red" },
          { id: "5", label: "Strawberry", categoryId: "red" },
          { id: "6", label: "SpongeBob", categoryId: "yellow" }
        ],
        []
      );
      const categories = useMemo(
        () => ({
          favorites: { id: "red", label: "I'm red", color: "red" },
          workspace: { id: "yellow", label: "I'm yellow", color: "yellow" }
        }),
        []
      );
      return (
      ...
      return (
        <DialogContentContainer>
          <Combobox
            ...
            onAddNew={() =>
              setOptions([...options, { id: options.length + 1, label: `Option: ${options.length + 1}` }])
            }
          />
        </DialogContentContainer>
      );
...
<Canvas>
  <Story name="With virtualization optimization">
    {() => {
      ...
      return (
        <Flex gap={Flex.gaps.SMALL} style={{ width: "100%" }} justify={Flex.justify.CENTER} align={Flex.align.START}>
          <StoryDescription
