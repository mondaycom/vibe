                ...
                <Flex gap={Flex.gaps.SMALL}  style={{width:"100%"}} justify={Flex.justify.SPACE_AROUND} align={Flex.align.START} >
                    <StoryDescription description="Virtualization optimization without categories" vertical>
                        <DialogContentContainer style={{height: "200px"}}>
                            <Combobox options={options}  categories={categories} stickyCategories renderOnlyVisibleOptions placeholder="Placeholder text here" />
                        </DialogContentContainer>
                    </StoryDescription>
                    <StoryDescription description="Virtualization optimization with categories" vertical>
                        <DialogContentContainer style={{height: "200px"}}>
                            <Combobox options={options} categories={categories} stickyCategories placeholder="Placeholder text here" />
                        </DialogContentContainer>
                    </StoryDescription>
                </Flex>
            )
