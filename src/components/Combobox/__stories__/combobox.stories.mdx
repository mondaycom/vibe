    ...
    {() => {
      ...
      <div>
        <Flex direction={Flex.directions.COLUMN} gap={Flex.gaps.SMALL}>
          <StoryDescription description="Categories without divider">
            <DialogContentContainer>
              <Combobox options={options} categories={categories} placeholder="Placeholder text here" />
            </DialogContentContainer>
          </StoryDescription>
          <StoryDescription description="Categories with divider">
            <DialogContentContainer>
...
If you want to render the result or no result placeholder only after loading is finished, use disableNoResultRendererOnLoading
<Canvas>
  <Story name="Empty list while loading">
    {() => {
      const options = useMemo(() => [
      ], []);
      return (
        <DialogContentContainer>
          <Combobox loading disableNoResultRendererOnLoading options={options} placeholder="Board name" />
        </DialogContentContainer>
      )
    }}
  </Story>
...
<Canvas>
  <Story name="Combobox as person picker">
    {() => {
        const options = useMemo(
          () => [
            {
        ...
        <Dialog
          content={() => (
            <DialogContentContainer className="combobox-stories-styles_wrapper">
              <Combobox options={options} categories={categories} optionRenderer={optionRenderer} size={Combobox.sizes.LARGE}/>
            </DialogContentContainer>
          )}
          tooltip
