...
import { ComponentRules, Link, RelatedComponents, UsageGuidelines } from "../../../storybook/components";
...
<Tip>
  ...
  <Link href="/?path=/docs/feedback-toast--overview" size={Link.sizes.SMALL} withoutSpacing>
    Toast.
  </Link>
</Tip>
  ...
  rules={[
    {
      positive: {
        ...
        description: "Use banners for system messages, background plugins, and general updates."
      },
      negative: {
        component: (
          <AlertBanner className="monday-storybook-alert-banner_medium-container">
        ...
        description: (
          <>
            ...
            <Link href="/?path=/docs/feedback-toast--overview" withoutSpacing>
              Toast.
            </Link>
          </>
        )
