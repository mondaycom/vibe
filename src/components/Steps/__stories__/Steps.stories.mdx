...
<Canvas>
  <Story name="Types">
    <div className="monday-style-story-steps_column-wrapper">
      ...
      <Steps steps={steps5} activeStepIndex={2} areNavigationButtonsHidden className="monday-style-story-steps_padding" />
    </div>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="On primary">
    <div className="monday-style-story-steps_column-wrapper monday-style-story-steps_color" >
      ...
      <Steps steps={steps5} activeStepIndex={2} isOnPrimary areNavigationButtonsHidden className="monday-style-story-steps_padding" />
    </div>
  </Story>
</Canvas>
