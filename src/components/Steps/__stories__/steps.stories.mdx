...
<Canvas>
  <Story name="Types">
    {() => {
      ...
      return (
        <div className="monday-storybook-steps_column-wrapper">
...
<Canvas>
  <Story name="On primary">
    {() => {
      const steps = useMemo(() => [<div />, <div />, <div />, <div />, <div />], []);
      return (
        <div className="monday-storybook-steps_column-wrapper monday-storybook-steps_color">
