...
<Canvas>
  <Story
    ...
    args={{
      ...
      className: "monday-storybook-expand-collapse"
    }}
  >
...
<Canvas>
  <Story name="Open by default">
    <ExpandCollapse title="Open by default" defaultOpenState className="monday-storybook-expand-collapse">
    ...
    {() => {
      ...
      return (
        <Flex direction={Flex.directions.ROW} gap={Flex.gaps.LARGE} align={Flex.align.START}>
          ...
          <Button onClick={() => setOpen(prevState => !prevState)}>Toggle open state</Button>
        </Flex>
      );
    }}
  </Story>
...
<Canvas>
  <Story name="Without borders">
    <ExpandCollapse hideBorder title="Without borders" className="monday-storybook-expand-collapse">
      <Text maxLines={2}>Insert here any component that you want</Text>
    </ExpandCollapse>
  </Story>
</Canvas>
