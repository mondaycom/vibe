...
<Tip>
  For creating e a popover positioned next to other components, like customized menus, check out our Dialog component.
</Tip>
    ...
    {() => {
      ...
      return (
        ...
        <div className="check">
          ...
          >
            <ModalContent id="modala">
              <Dropdown
                multi
                defaultValue={[options[0], options[1]]}
                options={options}
                popupsContainerSelector={"#checkit"}
              />
            </ModalContent>
            <ModalFooter>
              <Flex justify={Flex.justify.END} gap={12}>
