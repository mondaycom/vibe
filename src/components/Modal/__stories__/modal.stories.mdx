...
import { ComponentRules, createStoryMetaSettingsDecorator, RelatedComponentsDecorator, Tip, UsageGuidelines } from "../../../storybook";
...
<RelatedComponentsDecorator componentsNames={[TOOLTIP, ATTENTION_BOX, TOAST]} />
