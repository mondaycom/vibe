...
<Meta
  ...
  component={Modal}
  subcomponents={{ ModalHeader, ModalContent, ModalFooter, ModalFooterButtons }}
      ...
      return (
        ...
        <div>
          ...
          >
            ...
            <ModalHeader title={"Modal Title"} icon={Upgrade} iconSize={32} />
            <ModalContent>Modal content goes here</ModalContent>
            <ModalFooterButtons onPrimaryButtonClick={closeModal} onSecondaryButtonClick={closeModal} />
          </Modal>
        </div>
      ...
      positive: {
        component: (
          <ModalExampleWrapper bestPractice modalTitle="Modal title" buttonTitle="Click here">
            Modal with a proper CTA example
          </ModalExampleWrapper>
        ),
