...
import {AVATAR_GROUP, LABEL, TOOLTIP} from "../../../storybook/components/related-components/component-description-map";
...
To group multiple Avatars together, use the <Link href="/?path=/docs/media-avatar-avatargroup--docs">`<AvatarGroup/>`</Link> component
