...
import { ComponentRules, createComponentTemplate } from "monday-ui-storybook-blocks";
import { Tip, StoryDescription, Link, createStoryMetaSettingsDecorator } from "../../../storybook";
...
<Tip>
  ...
  <a href="/?path=/docs/media-avatar-avatargroup--overview" size={Link.sizes.SMALL}>
    AvatarGroup
  </a>
  component
</Tip>
