...
import { Link, RelatedComponentsDecorator, Tip, UsageGuidelines } from "../../../storybook/components";
import {
  ALERT_BANNER,
  ATTENTION_BOX,
  TOOLTIP
...
<RelatedComponentsDecorator componentsNames={[ALERT_BANNER, TOOLTIP, ATTENTION_BOX]} />
