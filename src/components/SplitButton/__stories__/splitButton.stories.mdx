...
<UsageGuidelines
  guidelines={[
    <>
      A split button is a hybrid between a button and a menu: it groups related commands together into a{" "}
...
<Canvas>
  <Story name="Icons">
    <SplitButton leftIcon={Check} secondaryDialogContent={<SplitButtonExampleDialog />}>Left icon</SplitButton>
    <SplitButton rightIcon={Check} secondaryDialogContent={<SplitButtonExampleDialog />}>Right icon</SplitButton>
    <SplitButton leftIcon={Check} secondaryDialogContent={<SplitButtonExampleDialog />}/>
  </Story>
</Canvas>
