...
<Meta title="Data display/Chips" component={Chips} />
...
<Tip>Chips will always show up in context of a field. If you just need to add information, use <Link href="/?path=/docs/data-display-label--overview" size={Link.sizes.SMALL} withoutSpacing>Label.</Link></Tip>
