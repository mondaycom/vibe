...
The chips have a prop which adds a border to them, this should be used when the chip is being displayed on a colored background

<Canvas>
  <Story name="On color">
    <Flex style={{ width: "100%", height: 300 }} align={Flex.align.STRETCH} justify={Flex.justify.CENTER}>
      <Flex
      ...
      >
        <Chips label="On selected" showBorder />
      </Flex>
      <Flex
        align={Flex.align.CENTER}
        justify={Flex.justify.CENTER}
      ...
      >
        <Chips label="On positive" showBorder color={Chips.colors.POSITIVE} />
      </Flex>
      <Flex
        align={Flex.align.CENTER}
        justify={Flex.justify.CENTER}
      ...
      >
        <Chips label="On negative" showBorder color={Chips.colors.NEGATIVE} />
      </Flex>
      <Flex
        align={Flex.align.CENTER}
        justify={Flex.justify.CENTER}
      ...
      >
        <Chips label="On black" showBorder />
      </Flex>
    </Flex>
  </Story>
</Canvas>
