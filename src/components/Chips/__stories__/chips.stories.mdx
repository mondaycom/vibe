...
<Canvas>
  <Story name="On color">
    <Flex style={{ width: "100%" }} align={Flex.align.STRETCH} justify={Flex.justify.START}>
      <Flex
...
<Canvas>
  <Story name="Overflowing chip">
    <Flex direction={Flex.directions.COLUMN} gap={Flex.gaps.LARGE}>
      <Chips label="Chip with limited width" className="monday-storybook-chips_overflowing_chip" />
      <div className="monday-storybook-chips_overflowing_chip_container">
        <Chips
          label="Chip inside container with limited width"
          className="monday-storybook-chips_overflowing_chip_container--chip"
        />
      </div>
      <Chips label="Chip with limited width" className="monday-storybook-chips_overflowing_chip" disabled />
      <div className="monday-storybook-chips_overflowing_chip_container">
        <Chips
          label="Chip inside container with limited width"
          className="monday-storybook-chips_overflowing_chip_container--chip"
      ...
      <Chips label="Chip with limited width" className="monday-storybook-chips_overflowing_chip" onClick={NOOP} />
      <div className="monday-storybook-chips_overflowing_chip_container">
        <Chips
          label="Chip inside container with limited width"
          className="monday-storybook-chips_overflowing_chip_container--chip"
