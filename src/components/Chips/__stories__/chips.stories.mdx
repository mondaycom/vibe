...
<Canvas>
  <Story name="Overview" args={{ label: "This is a chip", readOnly: true }}>
    {chipsTemplate.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="With avatars">
    <Chips label="Chip with left avatar" leftAvatar={person1} readOnly />
    <Chips label="Chip with right avatar" rightAvatar={person1} readOnly />
  </Story>
</Canvas>
...
Use chips with colors to indicate different categories<br />e.g. `<Chips label="GRASS_GREEN" color={Chips.colors.GRASS_GREEN} />`
