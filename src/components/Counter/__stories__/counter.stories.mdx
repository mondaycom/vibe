...
<Canvas>
  <Story name="Counter on inbox filters">
    <span>UX Writing & microcopy Re... <Counter count={195} color={Counter.colors.DARK} /></span>
    <span>Mobile Data- Iteration Plan...<Counter count={141} color={Counter.colors.DARK} /></span>
    <span>Q Plans <Counter count={99} color={Counter.colors.DARK} /></span>
  </Story>
</Canvas>
