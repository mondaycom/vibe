...
<Meta title="Navigation/Tabs/Tabs" component={Tab} subcomponents={{ TabPanel, TabPanels, TabList, TabsContext }} />
...
<Canvas>
  <Story name="Overview" args={{ className: "monday-storybook-tabs_bg-color" }}>
    {tabsTemplate.bind({})}
  </Story>
</Canvas>
...
// TODO this example demonstrates nothing - TabPanels animationDirection is getting overriden by TabsContext here, so no sense in passing animationDirection to TabPanels
