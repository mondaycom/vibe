...
import { Link, RelatedComponentsDecorator, UsageGuidelines } from "../../../storybook/components";
import {
  BREADCRUBMS,
  BUTTON_GROUP,
  STEPPER
...
<Canvas>
  <Story name="Overview" args={{ tabPanelClassName: "monday-storybook-tabs_bg-color" }}>
    {tabsTemplate.bind({})}
  </Story>
</Canvas>
...
<RelatedComponentsDecorator componentsNames={[BREADCRUBMS, BUTTON_GROUP, STEPPER]} />
