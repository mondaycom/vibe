...
import { DeprecatedWarning } from "vibe-storybook-components";
...
<DeprecatedWarning alternativeName="EditableHeading" alternativeLink="/?path=/docs/inputs-editableheading--overview" />
...
<Canvas>
  <Story name="Overview" play={overviewPlaySuite}>
    <EditableHeading value="This heading is editable" type={EditableHeading.types.h1} />
  </Story>
</Canvas>
