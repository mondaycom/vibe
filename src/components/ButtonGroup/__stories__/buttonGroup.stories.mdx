...
<UsageGuidelines
  guidelines={[
    ...
    <>
      ...
      <Link href="/?path=/docs/inputs-dropdown--overview">Dropdown</Link>
      component.
    </>,
    <>
...
<Tip title="Check yourself">
  Button group will always have one button selected. If you need to display adjacent buttons without selected mode, use
  the
      ...
      negative: {
        ...
        description: (
          <>
            ...
            <Link href="/?path=/docs/navigation-tabs-tabs--overview">
              Tabs
            </Link>
            instead.
          </>
