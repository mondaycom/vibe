...
<UsageGuidelines guidelines={[
  ...
  "Keep the content short and actionable. For longer actions, use the Dropdown component.",
  "Button group is used to diplay the same content in diffrent view, if you need to present diffrent content, use Tabs.",
]}/>

<Tip title="Check yourself">Button group will always have one button selected. If you need to display addjacent buttons without selected mode, use  the Button component with “Flat” props. </Tip>
