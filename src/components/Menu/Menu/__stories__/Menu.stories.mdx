...
import {
  ...
  menuKeyboardNavigationWithoutFocusTemplate,
...
### Menu with keybord navigation without focus
<Canvas>
  <Story name="Menu with keybord navigation without focus">
    {menuKeyboardNavigationWithoutFocusTemplate.bind({})}
  </Story>
</Canvas>
