...
<Canvas>
  <Story name="Hover vs Clickable">
    {() => {
      const [lastClickedName, setLastClickedName] = useState(null);
      const avatarOnClick = useCallback((e) => {
        console.log("click e", e);
        console.log("click e.target.id", e.target.id);
        console.log("click e.target", e.target);
        setLastClickedName(e.target.alt);
      }, []);
      return (
        <Flex direction={Flex.directions.COLUMN} gap={Flex.gaps.LARGE} align={Flex.align.START}>
          <Flex direction={Flex.directions.ROW} gap={Flex.gaps.LARGE}>
            ...
            <StoryDescription description="Counter click" vertical align={Flex.align.START}>
              <AvatarGroup size={Avatar.sizes.LARGE} max={3}>
                <Avatar type={Avatar.types.IMG} src={person1} onClick={avatarOnClick} id="1" ariaLabel="Hadas Fahri" />
                <Avatar
                  type={Avatar.types.IMG}
                  src={person2}
                ...
                <Avatar
                  ...
                  onClick={avatarOnClick}
                  id="3"
                  ariaLabel="Yonatan Lev Ari"
                />
                <Avatar type={Avatar.types.IMG} src={person1} onClick={avatarOnClick} id="4" ariaLabel="Hadas Fahri" />
                <Avatar
                  type={Avatar.types.IMG}
                  src={person2}
                  onClick={avatarOnClick}
                ...
                <Avatar
                  ...
                  ariaLabel="Yonatan Lev Ari"
                />
                <Avatar type={Avatar.types.IMG} src={person1} onClick={avatarOnClick} ariaLabel="Hadas Fahri" />
                <Avatar type={Avatar.types.IMG} src={person2} onClick={avatarOnClick} ariaLabel="Sergey Roytman" />
                <Avatar type={Avatar.types.IMG} src={person3} onClick={avatarOnClick} ariaLabel="Yonatan Lev Ari" />
                <Avatar type={Avatar.types.IMG} src={person1} onClick={avatarOnClick} ariaLabel="Hadas Fahri" />
                <Avatar type={Avatar.types.IMG} src={person2} onClick={avatarOnClick} ariaLabel="Sergey Roytman" />
                <Avatar type={Avatar.types.IMG} src={person3} onClick={avatarOnClick} ariaLabel="Yonatan Lev Ari" />
                <Avatar text="MR" type={Avatar.types.TEXT} onClick={avatarOnClick} ariaLabel="Mark Roytstein" />
              </AvatarGroup>
            </StoryDescription>
          </Flex>
          <div>Last clicked avatar's name: {lastClickedName}</div>
        </Flex>
      );
    }}
  </Story>
