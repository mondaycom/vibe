...
<Canvas>
  <Story name="Overview">
    <AvatarGroup size={Avatar.sizes.LARGE} max={3}>
      ...
      <Avatar type={Avatar.types.IMG} src={person2} tooltipProps={{ content: "Sergey Roytman" }} />
      <Avatar type={Avatar.types.IMG} src={person3} tooltipProps={{ content: "Yonatan Lev Ari" }} />
      <Avatar type={Avatar.types.IMG} src={person1} tooltipProps={{ content: "Hadas Fahri" }} />
      <Avatar type={Avatar.types.IMG} src={person2} tooltipProps={{ content: "Sergey Roytman" }} />
      <Avatar type={Avatar.types.IMG} src={person3} tooltipProps={{ content: "Yonatan Lev Ari" }} />
      <Avatar type={Avatar.types.IMG} src={person1} tooltipProps={{ content: "Hadas Fahri" }} />
...
<Canvas>
  <Story name="Custom counter">
    ...
    >
      ...
      <Avatar src={person2} tooltipProps={{ content: "Sergey Roytman" }} />
      <Avatar src={person3} tooltipProps={{ content: "Yonatan Lev Ari" }} />
    </AvatarGroup>
  </Story>
</Canvas>
