...
import { Link, StoryDescription, createStoryMetaSettingsDecorator, RelatedComponentsDecorator } from "../../../storybook";
...
<RelatedComponentsDecorator componentsNames={[AVATAR, TOOLTIP, COUNTER]} />
