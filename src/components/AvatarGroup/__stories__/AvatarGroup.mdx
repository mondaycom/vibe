...
If avatars are clickable, they will be displayed via<Link href="/?path=/docs/navigation-menu-menu--docs">Menu</Link>and user will be able to navigate each additional item.
