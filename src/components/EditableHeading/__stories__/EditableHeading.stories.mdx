...
<Canvas>
  <Story name="Colors">
    <EditableHeading type={EditableHeading.types.h1} value="H1 Header" color="blue" />
    <EditableHeading type={EditableHeading.types.h2} value="H2 Header" color="red" />
    <EditableHeading type={EditableHeading.types.h3} value="H3 Header" highlightTerm="head" color="#AA33FF" />
  </Story>
</Canvas>
