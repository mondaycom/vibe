...
import { overviewPlaySuite } from "../__tests__/editable-heading-interactions";
...
<Canvas>
  <Story name="Overview" args={{ value: "This heading is editable", type: EditableHeading.types.h1 }} play={overviewPlaySuite} >
