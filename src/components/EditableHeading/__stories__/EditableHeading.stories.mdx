...
<Canvas>
  <Story name="Weights">
    <EditableHeading type={EditableHeading.types.h2} weight={EditableHeading.weights.light} value="H2 Header light" />
    <EditableHeading
      type={EditableHeading.types.h2}
      weight={EditableHeading.weights.normal}
      value="H2 Header normal"
    />
    <EditableHeading type={EditableHeading.types.h2} weight={EditableHeading.weights.bold} value="H2 Header bold" />
  </Story>
</Canvas>
