...
<Canvas columns={3}>
  <Story name="On color states">
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div className="monday-storybook-button_on-color-button">
        <Button color={Button.colors.FIXED_LIGHT} marginRight>
          Primary fixed light
        </Button>
        <Button color={Button.colors.FIXED_LIGHT} kind={Button.kinds.SECONDARY} marginRight>
          Secondary fixed light
        </Button>
        <Button color={Button.colors.FIXED_LIGHT} kind={Button.kinds.TERTIARY}>
      ...
      <div className="monday-storybook-button_on-color-button">
        <Button color={Button.colors.FIXED_LIGHT} disabled marginRight>
          Primary fixed light
        </Button>
        <Button color={Button.colors.FIXED_LIGHT} disabled kind={Button.kinds.SECONDARY} marginRight>
          Secondary fixed light
        </Button>
        <Button color={Button.colors.FIXED_LIGHT} disabled kind={Button.kinds.TERTIARY}>
          Tertiary fixed light
        </Button>
      </div>
      <br />
      <span style={{ marginBottom: "var(--sb-spacing-small)" }}>Active</span>
      <div className="monday-storybook-button_on-color-button">
        <Button color={Button.colors.ON_PRIMARY_COLOR} marginRight active>
          Primary on color
        </Button>
        <Button color={Button.colors.ON_PRIMARY_COLOR} kind={Button.kinds.SECONDARY} marginRight active>
          Secondary on color
        </Button>
        <Button color={Button.colors.ON_PRIMARY_COLOR} kind={Button.kinds.TERTIARY} active>
          Tertiary on color
        </Button>
      </div>
      <div className="monday-storybook-button_on-color-button">
        <Button color={Button.colors.FIXED_LIGHT} marginRight active>
          Primary fixed light
        </Button>
        <Button color={Button.colors.FIXED_LIGHT} kind={Button.kinds.SECONDARY} marginRight active>
          Secondary fixed light
        </Button>
        <Button color={Button.colors.FIXED_LIGHT} kind={Button.kinds.TERTIARY} active>
          Tertiary fixed light
        </Button>
      </div>
    </div>
