...
describe("Skeleton Tests", () => {
  describe("Snapshot Tests", () => {
    ...
    it("renders correctly with not valid type", () => {
      const tree = renderer.create(<Skeleton type="not valid" />).toJSON();
      expect(tree).toMatchSnapshot();
    });
    ...
    describe("renders correctly when rectangle", () => {
      ...
      it("with not valid size", () => {
        const tree = renderer.create(<Skeleton type={Skeleton.types.RECTANGLE} size="not valid" />).toJSON();
        expect(tree).toMatchSnapshot();
      });
    ...
    describe("renders correctly when circle", () => {
      ...
      it("with not valid size", () => {
        const tree = renderer.create(<Skeleton type={Skeleton.types.CIRCLE} size="not valid" />).toJSON();
        expect(tree).toMatchSnapshot();
      });
    ...
    describe("renders correctly when text", () => {
      ...
      it("with not valid size", () => {
        const tree = renderer.create(<Skeleton type={Skeleton.types.TEXT} size="not valid" />).toJSON();
        expect(tree).toMatchSnapshot();
      });
