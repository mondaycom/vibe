          ...
          {showBlock && (
            <div className="monday-style-stories-skeleton_box">
              ...
              <div className="monday-style-stories-skeleton_btn-group">
                <Button className="monday-style-stories-skeleton_btn" leftIcon={ThumbsUp} kind={Button.kinds.SECONDARY}>
                  Like
                </Button>
                <Button className="monday-style-stories-skeleton_btn" leftIcon={Replay} kind={Button.kinds.SECONDARY}>
                  Reply
                </Button>
              </div>
            </div>
