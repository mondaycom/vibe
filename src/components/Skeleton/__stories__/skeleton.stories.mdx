...
<Tip>Using loader after the pages i fully loaded consider using the <Link href="/?path=/docs/components-loader--overview" size={Link.sizes.SMALL} withoutSpacing>loader component.</Link></Tip>
    ...
    {() => {
      ...
      return (
        <div className="monday-style-stories-skeleton_row">
          ...
          <Button kind={Button.kinds.SECONDARY} onClick={onClickCallback}>Load update</Button>
        </div>
      )
    }}
  </Story>
