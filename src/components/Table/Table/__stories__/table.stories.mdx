...
<Canvas>
  <Story name="Table Size Variants">
    {() => {
      const columns = emailColumns.slice(0, 2);
      const data = emailTableData.slice(0, 2);
      return (
        <>
          <Table errorState={<TableErrorState />} emptyState={<TableEmptyState />} columns={columns}>
            <TableHeader size={RowSizes.MEDIUM}>
            ...
            <TableBody>
              {data.map(rowItem => (
                <TableRow key={rowItem.id} size={RowSizes.MEDIUM}>
                  <TableCell>{rowItem.sentOn}</TableCell>
                  <TableCell>{rowItem.subject}</TableCell>
                </TableRow>
              ))}
          ...
          <Table errorState={<TableErrorState />} emptyState={<TableEmptyState />}
                 columns={columns}>
            <TableHeader size={RowSizes.LARGE}>
              {columns.map((headerCell, index) => (
                <TableHeaderCell
                  key={index}
                  title={headerCell.title}
            ...
            <TableBody>
              {data.map(rowItem => (
                <TableRow key={rowItem.id} size={RowSizes.LARGE}>
                  <TableCell>{rowItem.sentOn}</TableCell>
                  <TableCell>{rowItem.subject}</TableCell>
                </TableRow>
              ))}
