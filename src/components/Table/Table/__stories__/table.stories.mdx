...
import {
  ...
  scrollTablePriorityColumnToLabelColor,
  scrollTableStatusColumnToLabelColor,
  scrollTableData,
  scrollTableColumns
} from "./helpers";
import {
          ...
          {scrollTableData.map(rowItem => (
            <TableRow key={rowItem.id}>
              ...
              <TableCell>
                <Label
                  text={rowItem.status}
                  color={scrollTableStatusColumnToLabelColor[rowItem.status]}
                  isAnimationDisabled
                />
              </TableCell>
              <TableCell>
                <Label
                  ...
                  color={scrollTablePriorityColumnToLabelColor[rowItem.priority]}
                  isAnimationDisabled
                />
              </TableCell>
              <TableCell>{rowItem.emailsSent}</TableCell>
  ...
  rules={[
    {
      positive: {
        component: (
          <TableContainer>
            <Table errorState={<TableErrorState />} emptyState={<TableEmptyState />} columns={doAndDontIconsRuleData}>
              <TableHeader>
                {doAndDontIconsRuleData.map(cell => (
      ...
      negative: {
        component: (
          <TableContainer>
            <Table errorState={<TableErrorState />} emptyState={<TableEmptyState />} columns={doAndDontIconsRuleData}>
              <TableHeader>
                {doAndDontIconsRuleData.map((cell, index) => (
                  <TableHeaderCell key={cell.id} {...cell} icon={index === 0 ? cell.icon : undefined} />
                ))}
              </TableHeader>
            </Table>
          </TableContainer>
