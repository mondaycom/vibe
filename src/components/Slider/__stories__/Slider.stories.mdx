...
<Canvas>
  <Story name="Ranged">
    ...
    <Slider size={Slider.sizes.MEDIUM} isRange={true} defaultValue={[12, 55]} />
    <Slider size={Slider.sizes.LARGE} isRange={true} defaultValue={[25, 32]} />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Colors">
    ...
    <Slider color={Slider.colors.NEGATIVE} isRange={true} defaultValue={[12, 55]} size={Slider.sizes.MEDIUM} />
...
<Canvas>
  <Story name="Disabled">
    ...
    <Slider disabled={true} isRange={true} defaultValue={[12, 55]} color={Slider.colors.PRIMARY} size={Slider.sizes.MEDIUM} />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="WithLabels" decorators={[VerticalStories]}>
    ...
    <Slider indicateSelection={true} isRange={true} defaultValue={[12, 55]} size={Slider.sizes.SMALL} />
...
<Canvas>
  <Story name="ShowValue">
    <Slider showValue={true} defaultValue={12} size={Slider.sizes.SMALL} />
    <Slider showValue={true} defaultValue={55} size={Slider.sizes.MEDIUM} />
    <Slider showValue={true} defaultValue={89} size={Slider.sizes.LARGE} />
  </Story>
</Canvas>
