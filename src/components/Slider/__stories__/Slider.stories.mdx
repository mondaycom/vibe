...
<Tip title="Not what you were looking for?">
  ...
  <Link href="/?path=/docs/navigation-multistepindicator--overview" size={Link.sizes.SMALL} withoutSpacing>
    See link
  </Link>
</Tip>
...
<RelatedComponents componentsNames={[PROGRESS_BAR, TOGGLE, MULTI_STEP_INDICATOR]} />
