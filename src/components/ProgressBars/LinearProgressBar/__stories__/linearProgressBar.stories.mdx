...
<Tip>If you need to lead a user through a progress, use the <Link href="/?path=/docs/components-stepper--overview" size={Link.sizes.SMALL} withoutSpacing>Stepper</Link> instead.</Tip>
