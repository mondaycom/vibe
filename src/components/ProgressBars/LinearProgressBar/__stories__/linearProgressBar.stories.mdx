...
<Tip>If you need to lead a user through a progress, use the <Link href="/?path=/docs/navigation-multistepindicator--overview" size={Link.sizes.SMALL} withoutSpacing>Wizard</Link> instead.</Tip>
