...
<Tip>If you need to lead a user through a progress, use the <Link href="/?path=/docs/components-Wizard--overview" size={Link.sizes.SMALL} withoutSpacing>Wizard</Link> instead.</Tip>
  ...
  <Story name="Regular">
    <div className="linear-progress-bar_small-wrapper">
      <div className="linear-progress-bar_block">
        <LinearProgressBar indicateProgress value={30} size={LinearProgressBar.sizes.LARGE} />
        <>With label</>
      </div>
      <div className="linear-progress-bar_block">
        <LinearProgressBar value={30} size={LinearProgressBar.sizes.LARGE} />
        <>Without label</>
      </div>
    </div>
  </Story>
...
<Canvas>
  <Story name="With secondary value">
    <div className="linear-progress-bar_small-wrapper">
      <LinearProgressBar value={50} indicateProgress valueSecondary={65} size={LinearProgressBar.sizes.LARGE} />
    </div>
  </Story>
</Canvas>
