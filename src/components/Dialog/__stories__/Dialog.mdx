...
<UsageGuidelines
  guidelines={[
    ...
    <>
      ...
      <Link href="/?path=/docs/navigation-menu-menu--docs">Menu</Link>
      and
      <Link href="?path=/docs/buttons-menubutton--docs">MenuButton</Link>
      components.
    </>
  ]}
/>
...
<AttentionBox title="Trying to implement your own customize menu?">
  <>
    ...
    as our <AttentionBoxLink href="/?path=/docs/navigation-menu-menu--docs" text="Menu component" />, because
