...
Dialog has a <code>tooltip</code> prop which adds an arrow pointing toward the center of the reference.<Link href="https://popper.js.org/docs/v2/modifiers/arrow/">Read more</Link>
...
<Tip title="Dev tip">
  If you wish to implement a dropdown inside a Dialog container and need help displaying the dropdown's popovers
