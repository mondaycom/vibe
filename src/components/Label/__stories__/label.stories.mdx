...
<Canvas>
  <Story name="Clickable" parameters={{ chromatic: { pauseAnimationAtEnd: true }}}>
    <div className="monday-storybook-label_group monday-storybook-label_states-gap"><Label text="New" onClick={NOOP} /></div>
    <div className="monday-storybook-label_group monday-storybook-label_states-gap"><Label text="New" kind={Label.kinds.LINE} onClick={NOOP} /></div>
  </Story>
</Canvas>
