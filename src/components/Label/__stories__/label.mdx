...
<ComponentRules
  rules={[
    ...
    },
    {
      ...
      negative: {
        component: [
          <div className="monday-storybook-label_block" key="uniqueKey1">
            <h5>Categories</h5>
            <div className="monday-storybook-label_inline-block">
              <Label key="uniqueKey2" text="Featured" />
              <Label key="uniqueKey3" text="CRM" />
              <Label key="uniqueKey4" text="Export" />
            </div>
          </div>
        ],
        description: (
    ...
    {
      positive: {
        component: [<Label key="uniqueKey7"text="New" kind={Label.kinds.LINE} />, <Label key="uniqueKey8" text="Beta" />],
