...
<Tip>If you need an action that does not have context with text <StorybookLink href="/?path=/docs/inputs-combobox--overview" size={StorybookLink.sizes.SMALL} withoutSpacing>Button</StorybookLink>.</Tip>
...
<ComponentRules
  rules={[
    ...
    {
      positive: {
        component: <Link text="Read more" iconPosition={Link.iconPositions.START} href="https://www.monday.com" icon={ExternalPage} />,
