...
import { BUTTON, CHIP, } from "../../../storybook/components/related-components/component-description-map";
...
<Canvas>
  <Story name="Reference link">
    <>Lorem Ipsum has been the industry's <Link text="standard" href="https://www.monday.com" />standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </>
  </Story>
</Canvas>
...
## Related components
<RelatedComponents componentsNames={[BUTTON, BUTTON, CHIP]} />