      ...
      positive: {
        component: (
          <div>
            ...
            <AttentionBox
              text={
                <span className="monday-style-attention-box_info">
                  Get your monday.com notifications<Link>Learn More</Link>
                </span>
              }
              className="monday-style-attention-box_att-box"
            />
          </div>
        ),
        description:
        ...
        component: (
          <div>
            ...
            <AttentionBox
              text={
                <span className="monday-style-attention-box_info">
                  7 days left on your free trial <Link>Learn More</Link>
                </span>
              }
              compact
              className="monday-style-attention-box_att-box"
        ...
        <DialogContentContainer className="monday-style-attention-box_search-bar">
          ...
          <div className="monday-style-attention-box_search">
            <div className="monday-style-attention-box_inline-container">
              ...
              <span className="monday-style-attention-box_name">
