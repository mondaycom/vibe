...
import { createComponentTemplate, Link, UnstyledList, UnstyledListItem } from "../../../storybook";
...
<UsageGuidelines guidelines={[
  <span className="monday-storybook-checkbox_list">Use checkboxes to:
...
<ComponentRules
  rules={[
    ...
    {
      positive: {
        component:<div className="monday-storybook-checkbox_border"><Checkbox label="Option" checked /></div>,
