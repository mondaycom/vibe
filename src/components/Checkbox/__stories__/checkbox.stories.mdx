...
import { createComponentTemplate, createStoryMetaSettingsDecorator, RelatedComponentsDecorator } from "../../../storybook";
import {
  DROPDOWN,
  RADIO_BUTTON,
  TOGGLE
...
<RelatedComponentsDecorator componentsNames={[RADIO_BUTTON, TOGGLE, DROPDOWN]} />
