...
<Meta title="Inputs/Checkbox" component={Checkbox} decorators={metaSettings.decorators} />
  ...
  <Story name="Single checkbox">
    <Checkbox
      ...
      label={
        <>
          I agree to the
          <Link size={Link.sizes.SMALL}>Terms of Service</Link>
          and{" "}
          <Link size={Link.sizes.SMALL} withoutSpacing>
            Privacy Policy
          </Link>
          .
        </>
