  ...
  rules={[
    {
      ...
      negative: {
        ...
        description:<>Don't use radio buttons when allowing the user to select more than one item from a list. In this case, use <Link href="/?path=/docs/components-checkbox--overview" withoutSpacing>checkbox</Link> instead.</>
      }               
    },
    {
      positive: {
