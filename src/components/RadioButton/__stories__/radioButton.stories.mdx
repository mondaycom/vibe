...
export const metaSettings = createStoryMetaSettings({ component: RadioButton });

<Meta title="Inputs/Radio Button" component={RadioButton} decorators={metaSettings.decorators} />
