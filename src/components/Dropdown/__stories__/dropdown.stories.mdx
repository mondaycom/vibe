...
import { overviewPlaySuite, multiInteractionTests } from "../__tests__/Dropdown.interactions";
import person1 from "./assets/person1.png";
import person3 from "./assets/person3.png";
import person2 from "./assets/person2.png";
import { OptionRenderer } from "./OptionRenderer.js";
import { Attach, Email } from "../../Icon/Icons";
import { Dropdown, DialogContentContainer, Button, Flex, Avatar, Label, ModalContent, Modal, Box } from "../../index";
...
<Canvas>
  <Story name="Multi-choice with different states" play={multiInteractionTests}>
    {() => {
      const options = useMemo(
        () => [
          {
      ...
      return (
        <Flex wrap gap={Flex.gaps.MEDIUM}>
          ...
          <StoryDescription description="Hidden options list" vertical headerStyle={{ width: 190 }}>
            <div style={{ width: "400px" }}>
              <Dropdown
...
<Canvas>
  <Story name="Dropdown with labels">
    {() => {
...
<Tip title="Dev tip">
  For more details about dropdown's APIs for displaying correctly inside{" "}
  <Link href="/?path=/docs/components-dialog-dialog--overview" size={Link.sizes.SMALL} withoutSpacing>
    Dialogs
  </Link>
  , <Link href="/?path=/docs/feedback-modal--overview" size={Link.sizes.SMALL} withoutSpacing>
    Modals
  </Link> and other popovers click <Link
...
<Canvas>
  <Story name="Dropdown inside popover">
    {() => {
      const options = useMemo(
        () => [
          { value: "1", label: "Option 1" },
      ...
      const dialogStyle = { width: "350px", height: "200px", overflow: "auto" };
      return (
...
<Canvas>
  <Story name="Dropdown value selection">
    {() => {
      const options = useMemo(
        () => [
          { value: "1", label: "Option 1" },
