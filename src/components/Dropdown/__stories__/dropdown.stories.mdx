...
Use dropdown inside scrollable dialog without the dropdown menu being affect/hidden as part of the overflow:scroll/auto/hidden of its container
by using our dropdown ability: <b>insideScroll</b>.
<Canvas>
