...
import { Attach, CloseSmall, Email } from "../../Icon/Icons";
import { DialogContentContainer, DropdownMenu, DropdownOption, DropdownSingleValue, Icon } from "../../index";
    ...
    {() => {
      ...
      return (
        <Dropdown
          ...
          placeholder="Dropdown with menu renderer"
        />
      );
    }}
  </Story>
    ...
    {() => {
      ...
      return (
        <Dropdown
          ...
          options={options}
          optionRenderer={OptionRenderer}
          placeholder="Dropdown with option renderer"
        />
      );
    }}
  </Story>
  ...
  <Story name="Value renderer">
    {() => {
      ...
      const ValueRenderer = props => {
        return <DropdownSingleValue {...props} singleValueWrapperClassName={"valueRendererInner"} />;
      };
      return (
        <Dropdown
          className="dropdown-stories-styles_spacing"
          ...
          singleValueWrapperClassName={"valueRenderer"}
          placeholder="Dropdown with value renderer"
        />
      );
    }}
  </Story>
...
<Tip title="Dev tip">
  For more details about dropdown's APIs for displaying correctly inside Dialogs, Modals and other popovers{" "}
  <Link
