...
Use <b>insideOverflowContainer</b> prop attribute for displaying drop down inside scrollable dialog / container, or container
with overflow hidden content. If your dropdown container use transform css function
(like in vibe dialogs for example), please also attached the <b>transformContainerRef</b> like in the following story:
...
<Canvas>
    <Story name="Dropdown inside scrollable dialog">
        {() => {
            ...
            const secondDialogContent = <DialogContentContainer style={dialogStyle} ref={dialogRef}>
                <Dropdown
                    placeholder="Dropdown inside a scrollable dialog"
                    options={options}
                    insideOverflowContainer
                    transformContainerRef={dialogRef}
                />
            ...
            return (
                <Flex gap={Flex.gaps.LARGE}>
                    ...
                    <Dialog ref={dialogRef} content={secondDialogContent} hideTrigger={Dialog.hideShowTriggers.CLICK_OUTSIDE} showTrigger={Dialog.hideShowTriggers.CLICK}>
