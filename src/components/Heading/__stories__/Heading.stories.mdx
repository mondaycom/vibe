...
<Canvas>
  <Story name="Colors">
    <Flex direction={Flex.directions.COLUMN} align={Flex.align.START} gap={Flex.gaps.SMALL}>
      <Heading color="primary">Primary title</Heading>
      <Heading color="secondary">Secondary title</Heading>
      <Heading element="div" className={styles.primaryBackground} align="center" color="onPrimary">
        On primary title
      </Heading>
      <Heading element="div" className={styles.invertedBackground} align="center" color="onInverted">
        On inverted title
      </Heading>
    </Flex>
  </Story>
