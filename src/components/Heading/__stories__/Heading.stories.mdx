...
<Canvas>
  <Story name="Weights">
    <div style={{ display: "flex", flexDirection: "column" }}>
      <Heading type={Heading.types.h1} value="Hello H1 light" weight={Heading.weights.light} />
      <Heading type={Heading.types.h1} value="Hello H1 normal" weight={Heading.weights.normal} />
      <Heading type={Heading.types.h1} value="Hello H1 bold" weight={Heading.weights.bold} />
    </div>
  </Story>
</Canvas>
