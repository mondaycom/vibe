...
<Canvas>
  <Story name="Not editable header of a page">
    <div style={{width: "100%"}}>
      ...
      <Divider/>
      <div className={classes["heading-as-page-header_commands"]} style={{display: "flex", alignItems: "center"}} >
        <Search wrapperClassName={classes["heading-as-page-header_search"]}/>
