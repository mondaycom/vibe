...
<Canvas>
  <Story name="Overview" args={{ shouldShowOnMount: true, content: "I’m a tooltip" }}  parameters={{ chromatic: { pauseAnimationAtEnd: true }}}>
...
<Canvas>
  <Story name="Positions" parameters={{ chromatic: { pauseAnimationAtEnd: true }}}>
