...
There are 2 modes: Regular, Compact
  ...
  <Story name="Modes">
    {() => {
      const steps = useMemo(
        () => [
          ...
          },
          {
            key: "ACTIVE",
            status: MultiStepIndicator.stepStatuses.ACTIVE,
            titleText: "Active title with long title",
            subtitleText: "Active subtitle"
          },
          {
            key: "PENDING",
      ...
      return (
        <div className="monday-storybook-multiStepIndicator_column-wrapper">
          <div className="monday-storybook-multiStepIndicator_row-wrapper">
            <span className="monday-storybook-multiStepIndicator_title">Regular</span>
            <MultiStepIndicator steps={steps} mode={MultiStepIndicator.modes.REGULAR} />
          </div>
          <div className="monday-storybook-multiStepIndicator_row-wrapper">
            <span className="monday-storybook-multiStepIndicator_title">Compact</span>
            <MultiStepIndicator steps={steps} mode={MultiStepIndicator.modes.COMPACT} />
          </div>
        </div>
      );
    }}
