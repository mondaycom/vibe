...
<Canvas>
  <Story name="Vertical positions">
    <Flex
      style={{width: "100%"}}
      verticalPosition={Flex.verticalPositions.START}
      horizontalPosition={Flex.horizontalPositions.SPACE_AROUND}>
      <StoryDescription description="Start position" vertical>
        <Flex verticalPosition={Flex.verticalPositions.START} vertical style={{height: "300px"}}>
          <Button>Primary</Button>
          <Button kind={Button.kinds.TERTIARY}>Tertiary</Button>
          <Button kind={Button.kinds.TERTIARY}>Tertiary</Button></Flex>
      </StoryDescription>
      <StoryDescription description="Center position" vertical>
        <Flex verticalPosition={Flex.verticalPositions.CENTER} vertical style={{height: "300px"}}>
          <Button>Primary</Button>
          <Button kind={Button.kinds.TERTIARY}>Tertiary</Button>
          <Button kind={Button.kinds.TERTIARY}>Tertiary</Button>
        </Flex>
      ...
      <StoryDescription description="End position" vertical>
        <Flex verticalPosition={Flex.verticalPositions.END} vertical style={{height: "300px"}}>
          <Button>Primary</Button>
          <Button kind={Button.kinds.TERTIARY}>Tertiary</Button>
          <Button kind={Button.kinds.TERTIARY}>Tertiary</Button>
        </Flex>
