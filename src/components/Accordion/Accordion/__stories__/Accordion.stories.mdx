...
export const accordionTemplate = createComponentTemplate(Accordion);
...
<Canvas>
  <Story name="Multi active">
    <Accordion allowMultiple defaultIndex={[1, 3]}>
      ...
      <AccordionItem title="Setting"></AccordionItem>
      <AccordionItem title="Connectivity" />
      <AccordionItem title="Integration"></AccordionItem>
