...
import { WIZARD, BREADCRUBMS, TOAST } from "../../../../storybook/components/related-components/component-description-map";
...
## Related components
<RelatedComponents componentsNames={[WIZARD,BREADCRUBMS]} />
