...
<UsageGuidelines guidelines={[
  "Icon button will always appear with a tooltip while hovering, defining the icon’s meaning.",
...
<Tip title="Check yourself">To display icons that do not have actions associated with them, use the Icon component.</Tip>
  ...
  rules={[
    {
      ...
      negative: {
        ...
        description:"Don’t use Icon button as the main action on the page. Instead, use the Button component with an icon."
      }
    },
    {
      positive: {
