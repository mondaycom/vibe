...
import { Bolt, Robot, Doc, Pin, Show, HighlightColorBucket, Broom, Add, Time } from "../../Icon/Icons";
...
import LinkComponent  from "../../Link/Link"; import { Button, Flex } from "components";
  ...
  <Story name="Icon button as close button">
    <Flex>
      <Flex direction={Flex.directions.COLUMN}>
        <Flex>
          <Icon icon={Item}/>
          <span className="recycle-bin-icon-description">Item</span>
          Item
        </Flex>
        <Flex>
          <span><LinkComponent text="Hadas Farhi"/> deleted the item </span><span>Hello World</span><span>from the board</span>
        </Flex>
        <Flex>
          <Icon icon={Time}/>
          <span>13m</span>
    ...
    <IconButton ariaLabel="Remove from Recycle bin"/>
  </Story>
</Canvas>
