...
<Canvas>
  <Story name="Sizes">
      <div style={{ display: "flex", justifyContent:"space-evenly", alignItems: "center" , width: "100%"}}>
        <IconButton key="xxs" icon={Robot} size={IconButton.sizes.XXS} ariaLabel="My small IconButton"/>
        <IconButton key="xs" icon={Robot} size={IconButton.sizes.XS} ariaLabel="My small IconButton"/>
        <IconButton key="small" icon={Robot} size={IconButton.sizes.SMALL} ariaLabel="My small IconButton"/>
        <IconButton key="medium" icon={Robot} size={IconButton.sizes.MEDIUM} ariaLabel="My medium IconButton"/>
        <IconButton key="large" icon={Robot} size={IconButton.sizes.LARGE} ariaLabel="My large IconButton"/>
      </div>
  </Story>
</Canvas>
