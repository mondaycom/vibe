...
<UsageGuidelines guidelines={[
  <>Icon button will always appear with a <Link href="/?path=/docs/dialogs-and-pop-ups-tooltip--overview">tooltip</Link> while hovering, defining the icon’s meaning.</>,
