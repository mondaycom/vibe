...
<UsageGuidelines
  guidelines={[
    <>
      Icon button will always appear with a <Link href="/?path=/docs/popover-tooltip--docs">tooltip</Link> while
      ...
      negative: {
        ...
        description: (
          <>
            ...
            <Link href="/?path=/docs/buttons-button--docs">Button component</Link>
            with an icon.
          </>
        )
      }
