...
<Story of={ThemeProviderStories.ColorsEligibleForTheming} />
...
In case there is not <b>system theme</b> defined on <code>body</code> tag (or on any other element upper in DOM hierarchy), you can pass it as a prop to <code>ThemeProvider</code>.
