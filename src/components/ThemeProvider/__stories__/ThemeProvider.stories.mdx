      ...
      theme: {
        ...
        colors: {
          [SystemTheme.LIGHT]: {
            ...
            [Color.primaryHoverColor]: "darkgreen"
          },
          [SystemTheme.DARK]: {
            [Color.primaryColor]: "red",
            [Color.primaryHoverColor]: "darkred"
          },
          black: {
...
<UsageGuidelines
  guidelines={[
    "In most common case should only be used once to wrap whole application on a root level",
    "Usage guideline 2",
    "Usage guideline 3"
  ]}
/>
