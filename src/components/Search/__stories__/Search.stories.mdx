...
<Tip title="Missing something?">If you’re looking for search states, go to<Link href="/?path=/story/components-canvas--overview" size={Link.sizes.SMALL}>Canvas</Link>and play with Knobs.</Tip>
