...
<Tip title="Not what you were looking for?">If you need to filter results from a long list, consider using the Combobox component.</Tip>
...
<Tip title="Missing something?">If you’re looking for search states, go to Canvas and play with Knobs.</Tip>
