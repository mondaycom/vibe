...
import { Button, Combobox, DialogContentContainer, Flex } from "components";
...
<UsageGuidelines
  guidelines={[
    ...
    "Use sizes of the loader in context to its location the bigger the loading area use bigger loader",
    "Always place the loader in context to the loading content"
  ]}
/>
  ...
  <Story name="Size variants">
    <Flex direction={Flex.directions.ROW} gap={Flex.gaps.SMALL}>
      <StoryDescription description="Xs" vertical align={Flex.align.START}>
        <div className="monday-storybook-loader-size-variants-block">
    ...
    <Flex direction={Flex.directions.ROW} gap={Flex.gaps.SMALL}>
      ...
      <StoryDescription description="OnPrimary" vertical align={Flex.align.START}>
        <Flex direction={Flex.directions.ROW}>
          <div className="monday-storybook-loader-on-primary-block color-black">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
          <div className="monday-storybook-loader-on-primary-block color-negative">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
          <div className="monday-storybook-loader-on-primary-block color-positive">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
          <div className="monday-storybook-loader-on-primary-block color-primary">
            <Loader size={Loader.sizes.MEDIUM} color={Loader.colors.ON_PRIMARY} />
          </div>
        </Flex>
      </StoryDescription>
  ...
  <Story name="Visual variants">
    <Flex direction={Flex.directions.ROW} gap={Flex.gaps.SMALL}>
      <StoryDescription description="Casual" vertical align={Flex.align.START}>
        <div align="left">
          <Loader size={Loader.sizes.MEDIUM} type={Loader.types.CASUAL} />
        </div>
      </StoryDescription>
      <StoryDescription
      ...
      >
        <div align="left">
          <Loader size={Loader.sizes.MEDIUM} type={Loader.types.WITH_BACKGROUND} />
        </div>
      </StoryDescription>
    </Flex>
  </Story>
  ...
  rules={[
    {
      positive: {
        component: (
          <Flex direction={Flex.directions.ROW}>
            <div className="monday-storybook-loader-dos-and-donts-heading">H1 heading component</div>
            <Loader size={Loader.sizes.SMALL} type={Loader.types.WITH_BACKGROUND} />
          </Flex>
        ),
      ...
      negative: {
        component: (
          <Flex direction={Flex.directions.ROW}>
            <div className="monday-storybook-loader-dos-and-donts-heading">H1 heading component</div>
            <Loader size={Loader.sizes.LARGE} type={Loader.types.WITH_BACKGROUND} />
          </Flex>
        ),
...
<Canvas>
  <Story name="Loader in text field">
    <DialogContentContainer>
      <Combobox loading placeholder="Board name" />
    </DialogContentContainer>
  </Story>
</Canvas>
...
<RelatedComponents componentsNames={[BUTTON, SKELETON, PROGRESS_BAR]} />
