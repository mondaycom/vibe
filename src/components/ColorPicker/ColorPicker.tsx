...
(ColorPicker as any).COLOR_STYLES = COLOR_STYLES;
(ColorPicker as any).sizes = BASE_SIZES;

(ColorPicker as any).colorStyles = COLOR_STYLES;
(ColorPicker as any).colorSizes = BASE_SIZES;
(ColorPicker as any).colorShapes = COLOR_SHAPES;
