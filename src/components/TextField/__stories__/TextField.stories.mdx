...
<Canvas>
  <Story name="Overview"
         args={{ title: "Name", iconName: Show, validation: {text: "Helper text"}, wrapperClassName: "monday-storybook-text-field_size", showCharCount: true, placeholder: "Placeholder text here" }}>
...
<Canvas>
  <Story name="Input field with date and time">
    <div className="monday-storybook-text-field_size">
      <TextField
        size={TextField.sizes.MEDIUM}
        type={TextFieldTextType.DATE_TIME}
      />
    </div>
  </Story>
</Canvas>
