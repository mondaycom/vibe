...
import { DROPDAWN, SEARCH, COMBOBOX } from "../../../storybook/components/related-components/component-description-map";
...
## Related components
<RelatedComponents componentsNames={[DROPDAWN, SEARCH, COMBOBOX]} />