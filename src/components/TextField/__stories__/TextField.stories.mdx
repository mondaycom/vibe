...
import { ComponentRules, createComponentTemplate, UsageGuidelines } from "vibe-storybook-components";
import { Clear, Check, CloseSmall, Email, Show } from "../../Icon/Icons";
  ...
  <Story name="Test">
    {() => {
      const onChange = (value, event) => {
        console.log("### onChange", value, event.target.value, event.target);
      };
      return (
        <div className="monday-storybook-text-field_column-wrapper">
          <TextField iconName={Clear} clearOnIconClick onChange={onChange} placeholder="Small" name="small" />
          <TextField onChange={onChange}  placeholder="Medium" name="medium" size={TextField.sizes.MEDIUM} />
          <TextField onChange={onChange}  placeholder="Large" name="large" size={TextField.sizes.LARGE} />
        </div>
      );
    }}
  </Story>
  ...
  <Story name="Validation">
    <div className="monday-storybook-text-field_column-wrapper">
      <TextField
        ...
        title="Name"
        size={TextField.sizes.MEDIUM}
        validation={{ status: "error", text: "Validation text" }}
      />
    </div>
  </Story>
</Canvas>
